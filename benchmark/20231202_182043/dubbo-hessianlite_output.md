...
[INFO] 
[INFO] benchmark-base ..................................... SUCCESS [  2.845 s]
[INFO] server-base ........................................ SUCCESS [  0.329 s]
[INFO] client-base ........................................ SUCCESS [  0.608 s]
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.343 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  4.422 s
[INFO] Finished at: 2023-12-02T18:07:21Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.134 ±(99.9%) 0.058 ms/op
Iteration   1: 2.794 ±(99.9%) 0.014 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 2.894 ±(99.9%) 0.046 ms/op
Iteration   1: 1.765 ±(99.9%) 0.011 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.463 ±(99.9%) 0.063 ms/op
Iteration   1: 2.866 ±(99.9%) 0.015 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.387 ±(99.9%) 0.265 ms/op
Iteration   1: 7.214 ±(99.9%) 0.052 ms/op
...
Iteration   1: 2.876 ±(99.9%) 0.038 ms/op
                 ...
                 createUser·p0.9999: 18.914 ms/op
...
Result "org.apache.dubbo.benchmark.Client.existUser":
  ...
  Percentiles, ms/op:
     ...
     p(95.0000) =      2.554 ms/op
     p(99.0000) =      3.170 ms/op
     p(99.9000) =      6.898 ms/op
     p(99.9900) =      7.024 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.432 ±(99.9%) 0.107 ms/op
Iteration   1: 2.684 ±(99.9%) 0.029 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.845 ±(99.9%) 0.514 ms/op
Iteration   1: 8.064 ±(99.9%) 0.181 ms/op
                 listUser·p0.00:   1.268 ms/op
                 listUser·p0.50:   7.586 ms/op
                 listUser·p0.90:   10.404 ms/op
                 listUser·p0.95:   11.670 ms/op
                 listUser·p0.99:   25.956 ms/op
                 listUser·p0.999:  39.258 ms/op
...
Result "org.apache.dubbo.benchmark.Client.listUser":
  ...
  Percentiles, ms/op:
     ...
     p(95.0000) =     11.670 ms/op
     p(99.0000) =     25.956 ms/op
...
Client.existUser                       thrpt         15.518          ops/ms
Client.getUser                         thrpt          8.632          ops/ms
Client.listUser                        thrpt          3.535          ops/ms
Client.createUser                       avgt          2.794           ms/op
Client.existUser                        avgt          1.765           ms/op
Client.getUser                          avgt          2.866           ms/op
Client.listUser                         avgt          7.214           ms/op
Client.createUser                     sample  11129   2.876 ± 0.038   ms/op
...
Client.createUser:createUser·p0.9999  sample         18.914           ms/op
Client.createUser:createUser·p1.00    sample         18.940           ms/op
Client.existUser                      sample  18067   1.771 ± 0.012   ms/op
Client.existUser:existUser·p0.00      sample          0.677           ms/op
Client.existUser:existUser·p0.50      sample          1.673           ms/op
Client.existUser:existUser·p0.90      sample          2.295           ms/op
Client.existUser:existUser·p0.95      sample          2.554           ms/op
Client.existUser:existUser·p0.99      sample          3.170           ms/op
Client.existUser:existUser·p0.999     sample          6.898           ms/op
Client.existUser:existUser·p0.9999    sample          7.024           ms/op
Client.existUser:existUser·p1.00      sample          7.037           ms/op
Client.getUser                        sample  11916   2.684 ± 0.029   ms/op
Client.getUser:getUser·p0.00          sample          1.027           ms/op
Client.getUser:getUser·p0.50          sample          2.576           ms/op
Client.getUser:getUser·p0.90          sample          3.360           ms/op
Client.getUser:getUser·p0.95          sample          3.633           ms/op
Client.getUser:getUser·p0.99          sample          4.978           ms/op
Client.getUser:getUser·p0.999         sample         16.024           ms/op
Client.getUser:getUser·p0.9999        sample         16.122           ms/op
Client.getUser:getUser·p1.00          sample         16.122           ms/op
Client.listUser                       sample   3954   8.064 ± 0.181   ms/op
Client.listUser:listUser·p0.00        sample          1.268           ms/op
Client.listUser:listUser·p0.50        sample          7.586           ms/op
Client.listUser:listUser·p0.90        sample         10.404           ms/op
Client.listUser:listUser·p0.95        sample         11.670           ms/op
Client.listUser:listUser·p0.99        sample         25.956           ms/op
Client.listUser:listUser·p0.999       sample         39.258           ms/op
