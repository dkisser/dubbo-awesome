...
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.390 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  5.351 s
[INFO] Finished at: 2023-11-30T18:08:40Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 6.606 ±(99.9%) 0.136 ms/op
Iteration   1: 3.999 ±(99.9%) 0.023 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.273 ±(99.9%) 0.046 ms/op
Iteration   1: 2.351 ±(99.9%) 0.007 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 6.168 ±(99.9%) 0.065 ms/op
Iteration   1: 3.910 ±(99.9%) 0.017 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 15.512 ±(99.9%) 0.386 ms/op
Iteration   1: 8.955 ±(99.9%) 0.087 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 6.895 ±(99.9%) 0.221 ms/op
Iteration   1: 3.774 ±(99.9%) 0.050 ms/op
                 createUser·p0.00:   1.569 ms/op
                 createUser·p0.50:   3.547 ms/op
                 createUser·p0.90:   4.489 ms/op
                 createUser·p0.95:   5.628 ms/op
                 createUser·p0.99:   9.914 ms/op
                 createUser·p0.999:  15.246 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.826 ±(99.9%) 0.084 ms/op
Iteration   1: 2.296 ±(99.9%) 0.037 ms/op
                 ...
                 existUser·p0.9999: 27.351 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.454 ±(99.9%) 0.152 ms/op
Iteration   1: 3.945 ±(99.9%) 0.088 ms/op
                 getUser·p0.00:   0.816 ms/op
                 getUser·p0.50:   3.727 ms/op
                 getUser·p0.90:   4.891 ms/op
                 getUser·p0.95:   5.530 ms/op
                 getUser·p0.99:   13.548 ms/op
                 getUser·p0.999:  33.868 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 13.704 ±(99.9%) 0.499 ms/op
Iteration   1: 9.533 ±(99.9%) 0.215 ms/op
                 listUser·p0.00:   2.114 ms/op
                 listUser·p0.50:   8.847 ms/op
                 listUser·p0.90:   12.435 ms/op
                 listUser·p0.95:   14.074 ms/op
                 listUser·p0.99:   19.169 ms/op
                 listUser·p0.999:  49.676 ms/op
...
Client.createUser                      thrpt          4.701          ops/ms
Client.existUser                       thrpt          9.288          ops/ms
Client.getUser                         thrpt          6.732          ops/ms
Client.listUser                        thrpt          3.037          ops/ms
Client.createUser                       avgt          3.999           ms/op
Client.existUser                        avgt          2.351           ms/op
Client.getUser                          avgt          3.910           ms/op
Client.listUser                         avgt          8.955           ms/op
Client.createUser                     sample   8452   3.774 ± 0.050   ms/op
Client.createUser:createUser·p0.00    sample          1.569           ms/op
Client.createUser:createUser·p0.50    sample          3.547           ms/op
Client.createUser:createUser·p0.90    sample          4.489           ms/op
Client.createUser:createUser·p0.95    sample          5.628           ms/op
Client.createUser:createUser·p0.99    sample          9.914           ms/op
Client.createUser:createUser·p0.999   sample         15.246           ms/op
Client.createUser:createUser·p0.9999  sample         17.793           ms/op
Client.createUser:createUser·p1.00    sample         17.793           ms/op
Client.existUser                      sample  13920   2.296 ± 0.037   ms/op
Client.existUser:existUser·p0.00      sample          0.915           ms/op
Client.existUser:existUser·p0.50      sample          2.079           ms/op
Client.existUser:existUser·p0.90      sample          2.834           ms/op
Client.existUser:existUser·p0.95      sample          3.117           ms/op
Client.existUser:existUser·p0.99      sample          5.098           ms/op
Client.existUser:existUser·p0.999     sample         25.854           ms/op
Client.existUser:existUser·p0.9999    sample         27.351           ms/op
Client.existUser:existUser·p1.00      sample         27.492           ms/op
Client.getUser                        sample   8109   3.945 ± 0.088   ms/op
Client.getUser:getUser·p0.00          sample          0.816           ms/op
Client.getUser:getUser·p0.50          sample          3.727           ms/op
Client.getUser:getUser·p0.90          sample          4.891           ms/op
Client.getUser:getUser·p0.95          sample          5.530           ms/op
Client.getUser:getUser·p0.99          sample         13.548           ms/op
Client.getUser:getUser·p0.999         sample         33.868           ms/op
Client.getUser:getUser·p0.9999        sample         39.715           ms/op
Client.getUser:getUser·p1.00          sample         39.715           ms/op
Client.listUser                       sample   3299   9.533 ± 0.215   ms/op
Client.listUser:listUser·p0.00        sample          2.114           ms/op
Client.listUser:listUser·p0.50        sample          8.847           ms/op
Client.listUser:listUser·p0.90        sample         12.435           ms/op
Client.listUser:listUser·p0.95        sample         14.074           ms/op
Client.listUser:listUser·p0.99        sample         19.169           ms/op
Client.listUser:listUser·p0.999       sample         49.676           ms/op
