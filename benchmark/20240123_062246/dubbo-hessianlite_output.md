...
[INFO] Finished at: 2024-01-23T06:09:21Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.158 ±(99.9%) 0.076 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.037 ±(99.9%) 0.058 ms/op
Iteration   1: 2.939 ±(99.9%) 0.010 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.860 ±(99.9%) 0.188 ms/op
Iteration   1: 7.865 ±(99.9%) 0.077 ms/op
...
Iteration   1: 3.269 ±(99.9%) 0.068 ms/op
                 createUser·p0.00:   0.573 ms/op
                 createUser·p0.50:   2.830 ms/op
                 createUser·p0.90:   4.235 ms/op
                 createUser·p0.95:   5.156 ms/op
                 createUser·p0.99:   9.878 ms/op
                 createUser·p0.999:  32.511 ms/op
...
Iteration   1: 1.602 ±(99.9%) 0.007 ms/op
                 existUser·p0.00:   0.507 ms/op
                 existUser·p0.50:   1.548 ms/op
                 existUser·p0.90:   1.911 ms/op
                 existUser·p0.95:   2.126 ms/op
                 existUser·p0.99:   2.570 ms/op
                 existUser·p0.999:  4.858 ms/op
                 existUser·p0.9999: 4.948 ms/op
                 existUser·p1.00:   4.956 ms/op



Result "org.apache.dubbo.benchmark.Client.existUser":
  N = 19960
  mean =      1.602 ±(99.9%) 0.007 ms/op
  ...
  Percentiles, ms/op:
     ...
     p(99.0000) =      2.570 ms/op
     p(99.9000) =      4.858 ms/op
     p(99.9900) =      4.948 ms/op
     p(99.9990) =      4.956 ms/op
     p(99.9999) =      4.956 ms/op
    p(100.0000) =      4.956 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.905 ±(99.9%) 0.104 ms/op
Iteration   1: 3.391 ±(99.9%) 0.071 ms/op
                 getUser·p0.00:   0.856 ms/op
                 getUser·p0.50:   3.228 ms/op
                 getUser·p0.90:   4.084 ms/op
                 getUser·p0.95:   4.506 ms/op
                 getUser·p0.99:   6.519 ms/op
                 getUser·p0.999:  32.244 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.072 ±(99.9%) 0.361 ms/op
Iteration   1: 7.712 ±(99.9%) 0.116 ms/op
                 listUser·p0.00:   2.822 ms/op
                 listUser·p0.50:   7.414 ms/op
                 listUser·p0.90:   9.830 ms/op
                 listUser·p0.95:   10.895 ms/op
                 listUser·p0.99:   19.189 ms/op
                 listUser·p0.999:  24.099 ms/op
...
Result "org.apache.dubbo.benchmark.Client.listUser":
  ...
  Percentiles, ms/op:
     ...
     p(99.0000) =     19.189 ms/op
     p(99.9000) =     24.099 ms/op
...
Client.existUser                       thrpt         12.187          ops/ms
Client.getUser                         thrpt          9.109          ops/ms
Client.listUser                        thrpt          3.926          ops/ms
Client.createUser                       avgt          3.085           ms/op
Client.existUser                        avgt          2.012           ms/op
Client.getUser                          avgt          2.939           ms/op
Client.listUser                         avgt          7.865           ms/op
Client.createUser                     sample   9831   3.269 ± 0.068   ms/op
Client.createUser:createUser·p0.00    sample          0.573           ms/op
Client.createUser:createUser·p0.50    sample          2.830           ms/op
Client.createUser:createUser·p0.90    sample          4.235           ms/op
Client.createUser:createUser·p0.95    sample          5.156           ms/op
Client.createUser:createUser·p0.99    sample          9.878           ms/op
Client.createUser:createUser·p0.999   sample         32.511           ms/op
Client.createUser:createUser·p0.9999  sample         33.686           ms/op
Client.createUser:createUser·p1.00    sample         33.686           ms/op
Client.existUser                      sample  19960   1.602 ± 0.007   ms/op
Client.existUser:existUser·p0.00      sample          0.507           ms/op
Client.existUser:existUser·p0.50      sample          1.548           ms/op
Client.existUser:existUser·p0.90      sample          1.911           ms/op
Client.existUser:existUser·p0.95      sample          2.126           ms/op
Client.existUser:existUser·p0.99      sample          2.570           ms/op
Client.existUser:existUser·p0.999     sample          4.858           ms/op
Client.existUser:existUser·p0.9999    sample          4.948           ms/op
Client.existUser:existUser·p1.00      sample          4.956           ms/op
Client.getUser                        sample   9424   3.391 ± 0.071   ms/op
...
Client.getUser:getUser·p0.99          sample          6.519           ms/op
Client.getUser:getUser·p0.999         sample         32.244           ms/op
Client.getUser:getUser·p0.9999        sample         33.456           ms/op
Client.getUser:getUser·p1.00          sample         33.456           ms/op
Client.listUser                       sample   4140   7.712 ± 0.116   ms/op
...
Client.listUser:listUser·p0.99        sample         19.189           ms/op
Client.listUser:listUser·p0.999       sample         24.099           ms/op
