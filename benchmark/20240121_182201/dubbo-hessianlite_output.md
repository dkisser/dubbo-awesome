...
[INFO] Finished at: 2024-01-21T18:08:17Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.314 ±(99.9%) 0.070 ms/op
Iteration   1: 2.751 ±(99.9%) 0.009 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.151 ±(99.9%) 0.035 ms/op
...
Iteration   1: 3.089 ±(99.9%) 0.018 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.602 ±(99.9%) 0.218 ms/op
Iteration   1: 7.790 ±(99.9%) 0.077 ms/op
...
Iteration   1: 3.139 ±(99.9%) 0.054 ms/op
                 ...
                 createUser·p0.9999: 28.008 ms/op
...
Iteration   1: 3.280 ±(99.9%) 0.062 ms/op
                 getUser·p0.00:   0.811 ms/op
                 getUser·p0.50:   3.142 ms/op
                 getUser·p0.90:   4.121 ms/op
                 getUser·p0.95:   4.489 ms/op
                 getUser·p0.99:   6.437 ms/op
                 getUser·p0.999:  29.622 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.519 ±(99.9%) 0.423 ms/op
Iteration   1: 8.123 ±(99.9%) 0.121 ms/op
                 listUser·p0.00:   2.384 ms/op
                 listUser·p0.50:   7.840 ms/op
                 listUser·p0.90:   11.092 ms/op
                 listUser·p0.95:   12.059 ms/op
                 listUser·p0.99:   16.084 ms/op
                 listUser·p0.999:  19.794 ms/op
...
Client.createUser                      thrpt          5.500          ops/ms
Client.existUser                       thrpt         13.835          ops/ms
Client.getUser                         thrpt          8.023          ops/ms
Client.listUser                        thrpt          3.399          ops/ms
Client.createUser                       avgt          2.751           ms/op
Client.existUser                        avgt          1.916           ms/op
Client.getUser                          avgt          3.089           ms/op
Client.listUser                         avgt          7.790           ms/op
Client.createUser                     sample  10182   3.139 ± 0.054   ms/op
Client.createUser:createUser·p0.00    sample          1.073           ms/op
Client.createUser:createUser·p0.50    sample          2.781           ms/op
Client.createUser:createUser·p0.90    sample          3.894           ms/op
Client.createUser:createUser·p0.95    sample          4.456           ms/op
Client.createUser:createUser·p0.99    sample          9.617           ms/op
Client.createUser:createUser·p0.999   sample         27.394           ms/op
Client.createUser:createUser·p0.9999  sample         28.008           ms/op
Client.createUser:createUser·p1.00    sample         28.017           ms/op
Client.existUser                      sample  15461   2.069 ± 0.015   ms/op
Client.existUser:existUser·p0.00      sample          0.901           ms/op
Client.existUser:existUser·p0.50      sample          1.960           ms/op
Client.existUser:existUser·p0.90      sample          2.658           ms/op
Client.existUser:existUser·p0.95      sample          3.236           ms/op
Client.existUser:existUser·p0.99      sample          4.016           ms/op
Client.existUser:existUser·p0.999     sample          5.816           ms/op
Client.existUser:existUser·p0.9999    sample          6.618           ms/op
Client.existUser:existUser·p1.00      sample          6.676           ms/op
Client.getUser                        sample   9743   3.280 ± 0.062   ms/op
...
Client.getUser:getUser·p0.99          sample          6.437           ms/op
Client.getUser:getUser·p0.999         sample         29.622           ms/op
Client.getUser:getUser·p0.9999        sample         40.042           ms/op
Client.getUser:getUser·p1.00          sample         40.042           ms/op
Client.listUser                       sample   3928   8.123 ± 0.121   ms/op
...
Client.listUser:listUser·p0.99        sample         16.084           ms/op
Client.listUser:listUser·p0.999       sample         19.794           ms/op
