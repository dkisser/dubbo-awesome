...
[INFO] Finished at: 2024-01-13T06:08:13Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 7.350 ±(99.9%) 0.138 ms/op
Iteration   1: 4.979 ±(99.9%) 0.068 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.506 ±(99.9%) 0.058 ms/op
Iteration   1: 2.176 ±(99.9%) 0.021 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 8.185 ±(99.9%) 0.164 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 14.727 ±(99.9%) 0.265 ms/op
Iteration   1: 11.680 ±(99.9%) 0.312 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 6.803 ±(99.9%) 0.195 ms/op
Iteration   1: 3.923 ±(99.9%) 0.071 ms/op
                 createUser·p0.00:   1.362 ms/op
                 createUser·p0.50:   3.260 ms/op
                 createUser·p0.90:   6.136 ms/op
                 createUser·p0.95:   8.053 ms/op
                 createUser·p0.99:   12.684 ms/op
                 createUser·p0.999:  15.913 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.245 ±(99.9%) 0.134 ms/op
Iteration   1: 3.139 ±(99.9%) 0.064 ms/op
                 existUser·p0.00:   0.388 ms/op
                 existUser·p0.50:   2.560 ms/op
                 existUser·p0.90:   5.657 ms/op
                 existUser·p0.95:   7.162 ms/op
                 existUser·p0.99:   11.457 ms/op
                 existUser·p0.999:  14.310 ms/op
                 existUser·p0.9999: 17.659 ms/op
...
Result "org.apache.dubbo.benchmark.Client.existUser":
  ...
  Percentiles, ms/op:
     ...
     p(90.0000) =      5.657 ms/op
     p(95.0000) =      7.162 ms/op
     p(99.0000) =     11.457 ms/op
     p(99.9000) =     14.310 ms/op
     p(99.9900) =     17.659 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 8.171 ±(99.9%) 0.600 ms/op
Iteration   1: 3.807 ±(99.9%) 0.058 ms/op
                 getUser·p0.00:   0.878 ms/op
                 getUser·p0.50:   3.297 ms/op
                 getUser·p0.90:   5.877 ms/op
                 getUser·p0.95:   7.383 ms/op
                 getUser·p0.99:   9.264 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 15.047 ±(99.9%) 0.544 ms/op
Iteration   1: 9.851 ±(99.9%) 0.216 ms/op
                 listUser·p0.00:   2.892 ms/op
                 listUser·p0.50:   8.733 ms/op
                 listUser·p0.90:   15.729 ms/op
                 listUser·p0.95:   17.995 ms/op
                 listUser·p0.99:   21.295 ms/op
...
Result "org.apache.dubbo.benchmark.Client.listUser":
  ...
  Percentiles, ms/op:
     ...
     p(95.0000) =     17.995 ms/op
     p(99.0000) =     21.295 ms/op
...
Client.createUser                      thrpt          4.112          ops/ms
Client.existUser                       thrpt          9.289          ops/ms
Client.getUser                         thrpt          8.142          ops/ms
Client.listUser                        thrpt          3.102          ops/ms
Client.createUser                       avgt          4.979           ms/op
Client.existUser                        avgt          2.176           ms/op
Client.getUser                          avgt          3.552           ms/op
Client.listUser                         avgt         11.680           ms/op
Client.createUser                     sample   8179   3.923 ± 0.071   ms/op
Client.createUser:createUser·p0.00    sample          1.362           ms/op
Client.createUser:createUser·p0.50    sample          3.260           ms/op
Client.createUser:createUser·p0.90    sample          6.136           ms/op
Client.createUser:createUser·p0.95    sample          8.053           ms/op
Client.createUser:createUser·p0.99    sample         12.684           ms/op
Client.createUser:createUser·p0.999   sample         15.913           ms/op
Client.createUser:createUser·p0.9999  sample         16.941           ms/op
Client.createUser:createUser·p1.00    sample         16.941           ms/op
Client.existUser                      sample  10173   3.139 ± 0.064   ms/op
Client.existUser:existUser·p0.00      sample          0.388           ms/op
Client.existUser:existUser·p0.50      sample          2.560           ms/op
Client.existUser:existUser·p0.90      sample          5.657           ms/op
Client.existUser:existUser·p0.95      sample          7.162           ms/op
Client.existUser:existUser·p0.99      sample         11.457           ms/op
Client.existUser:existUser·p0.999     sample         14.310           ms/op
Client.existUser:existUser·p0.9999    sample         17.659           ms/op
Client.existUser:existUser·p1.00      sample         17.662           ms/op
Client.getUser                        sample   8455   3.807 ± 0.058   ms/op
Client.getUser:getUser·p0.00          sample          0.878           ms/op
Client.getUser:getUser·p0.50          sample          3.297           ms/op
Client.getUser:getUser·p0.90          sample          5.877           ms/op
Client.getUser:getUser·p0.95          sample          7.383           ms/op
Client.getUser:getUser·p0.99          sample          9.264           ms/op
Client.getUser:getUser·p0.999         sample         14.248           ms/op
Client.getUser:getUser·p0.9999        sample         15.548           ms/op
Client.getUser:getUser·p1.00          sample         15.548           ms/op
Client.listUser                       sample   3256   9.851 ± 0.216   ms/op
Client.listUser:listUser·p0.00        sample          2.892           ms/op
Client.listUser:listUser·p0.50        sample          8.733           ms/op
Client.listUser:listUser·p0.90        sample         15.729           ms/op
Client.listUser:listUser·p0.95        sample         17.995           ms/op
Client.listUser:listUser·p0.99        sample         21.295           ms/op
Client.listUser:listUser·p0.999       sample         23.788           ms/op
