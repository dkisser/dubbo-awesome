...
17.008 ±(99.9%) 0.291 ms/op
                 listUser·p0.00:   8.012 ms/op
                 listUser·p0.50:   15.622 ms/op
                 listUser·p0.90:   20.840 ms/op
                 listUser·p0.95:   22.384 ms/op
                 listUser·p0.99:   32.211 ms/op
                 listUser·p0.999:  44.349 ms/op
...
Client.createUser:createUser·p0.50    sample         5.521           ms/op
Client.createUser:createUser·p0.90    sample         6.947           ms/op
Client.createUser:createUser·p0.95    sample         9.880           ms/op
Client.createUser:createUser·p0.99    sample        17.072           ms/op
Client.createUser:createUser·p0.999   sample        20.949           ms/op
...
Client.existUser:existUser·p0.99      sample         9.470           ms/op
Client.existUser:existUser·p0.999     sample        12.173           ms/op
Client.existUser:existUser·p0.9999    sample        12.190           ms/op
...
Client.getUser:getUser·p0.50          sample         3.514           ms/op
Client.getUser:getUser·p0.90          sample         4.530           ms/op
Client.getUser:getUser·p0.95          sample         4.817           ms/op
Client.getUser:getUser·p0.99          sample         8.822           ms/op
Client.getUser:getUser·p0.999         sample        18.821           ms/op
Client.getUser:getUser·p0.9999        sample        19.268           ms/op
Client.getUser:getUser·p1.00          sample        19.268           ms/op
Client.listUser                       sample  1898  17.008 ± 0.291   ms/op
Client.listUser:listUser·p0.00        sample         8.012           ms/op
Client.listUser:listUser·p0.50        sample        15.622           ms/op
Client.listUser:listUser·p0.90        sample        20.840           ms/op
Client.listUser:listUser·p0.95        sample        22.384           ms/op
Client.listUser:listUser·p0.99        sample        32.211           ms/op
Client.listUser:listUser·p0.999       sample        44.349           ms/op
