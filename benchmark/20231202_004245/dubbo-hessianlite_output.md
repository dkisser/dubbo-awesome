...
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.442 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  4.591 s
[INFO] Finished at: 2023-12-02T00:29:04Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 6.268 ops/ms
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.726 ±(99.9%) 0.084 ms/op
Iteration   1: 2.959 ±(99.9%) 0.020 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.007 ±(99.9%) 0.029 ms/op
Iteration   1: 1.890 ±(99.9%) 0.009 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.869 ±(99.9%) 0.064 ms/op
Iteration   1: 2.835 ±(99.9%) 0.010 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 13.690 ±(99.9%) 0.290 ms/op
Iteration   1: 8.519 ±(99.9%) 0.108 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.437 ±(99.9%) 0.150 ms/op
Iteration   1: 3.162 ±(99.9%) 0.047 ms/op
                 createUser·p0.00:   0.703 ms/op
                 createUser·p0.50:   2.888 ms/op
                 createUser·p0.90:   3.817 ms/op
                 createUser·p0.95:   4.358 ms/op
                 createUser·p0.99:   10.715 ms/op
                 createUser·p0.999:  16.406 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.489 ±(99.9%) 0.108 ms/op
Iteration   1: 2.742 ±(99.9%) 0.017 ms/op
                 getUser·p0.00:   1.014 ms/op
                 getUser·p0.50:   2.658 ms/op
                 getUser·p0.90:   3.379 ms/op
                 getUser·p0.95:   3.756 ms/op
                 getUser·p0.99:   4.517 ms/op
                 getUser·p0.999:  7.368 ms/op
                 getUser·p0.9999: 7.599 ms/op
                 getUser·p1.00:   7.602 ms/op



Result "org.apache.dubbo.benchmark.Client.getUser":
  N = 11879
  mean =      2.742 ±(99.9%) 0.017 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.129 ±(99.9%) 0.383 ms/op
Iteration   1: 9.099 ±(99.9%) 0.128 ms/op
                 listUser·p0.00:   3.154 ms/op
                 listUser·p0.50:   8.716 ms/op
                 listUser·p0.90:   11.818 ms/op
...
Client.existUser                       thrpt         12.891          ops/ms
Client.getUser                         thrpt          8.182          ops/ms
Client.listUser                        thrpt          4.005          ops/ms
Client.createUser                       avgt          2.959           ms/op
Client.existUser                        avgt          1.890           ms/op
Client.getUser                          avgt          2.835           ms/op
Client.listUser                         avgt          8.519           ms/op
Client.createUser                     sample  10328   3.162 ± 0.047   ms/op
Client.createUser:createUser·p0.00    sample          0.703           ms/op
...
Client.createUser:createUser·p0.99    sample         10.715           ms/op
Client.createUser:createUser·p0.999   sample         16.406           ms/op
Client.createUser:createUser·p0.9999  sample         16.695           ms/op
Client.createUser:createUser·p1.00    sample         16.695           ms/op
Client.existUser                      sample  16537   1.933 ± 0.028   ms/op
Client.existUser:existUser·p0.00      sample          0.462           ms/op
Client.existUser:existUser·p0.50      sample          1.620           ms/op
Client.existUser:existUser·p0.90      sample          2.806           ms/op
Client.existUser:existUser·p0.95      sample          3.314           ms/op
Client.existUser:existUser·p0.99      sample          5.797           ms/op
Client.existUser:existUser·p0.999     sample         19.268           ms/op
Client.existUser:existUser·p0.9999    sample         19.850           ms/op
Client.existUser:existUser·p1.00      sample         20.021           ms/op
Client.getUser                        sample  11879   2.742 ± 0.017   ms/op
Client.getUser:getUser·p0.00          sample          1.014           ms/op
Client.getUser:getUser·p0.50          sample          2.658           ms/op
Client.getUser:getUser·p0.90          sample          3.379           ms/op
Client.getUser:getUser·p0.95          sample          3.756           ms/op
Client.getUser:getUser·p0.99          sample          4.517           ms/op
Client.getUser:getUser·p0.999         sample          7.368           ms/op
Client.getUser:getUser·p0.9999        sample          7.599           ms/op
Client.getUser:getUser·p1.00          sample          7.602           ms/op
Client.listUser                       sample   3526   9.099 ± 0.128   ms/op
Client.listUser:listUser·p0.00        sample          3.154           ms/op
Client.listUser:listUser·p0.50        sample          8.716           ms/op
Client.listUser:listUser·p0.90        sample         11.818           ms/op
Client.listUser:listUser·p0.95        sample         12.681           ms/op
Client.listUser:listUser·p0.99        sample         17.236           ms/op
Client.listUser:listUser·p0.999       sample         25.278           ms/op
