...
[INFO] 
[INFO] benchmark-base ..................................... SUCCESS [  3.022 s]
[INFO] server-base ........................................ SUCCESS [  0.350 s]
[INFO] client-base ........................................ SUCCESS [  0.654 s]
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.284 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  4.626 s
[INFO] Finished at: 2023-12-25T00:30:46Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.725 ±(99.9%) 0.075 ms/op
Iteration   1: 3.038 ±(99.9%) 0.018 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 2.911 ±(99.9%) 0.028 ms/op
Iteration   1: 1.867 ±(99.9%) 0.013 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.766 ±(99.9%) 0.068 ms/op
Iteration   1: 3.029 ±(99.9%) 0.017 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 13.109 ±(99.9%) 0.407 ms/op
Iteration   1: 8.243 ±(99.9%) 0.072 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.171 ±(99.9%) 0.121 ms/op
Iteration   1: 3.048 ±(99.9%) 0.034 ms/op
                 createUser·p0.00:   1.006 ms/op
                 createUser·p0.50:   2.808 ms/op
                 createUser·p0.90:   3.921 ms/op
                 createUser·p0.95:   4.219 ms/op
                 createUser·p0.99:   8.253 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.126 ±(99.9%) 0.077 ms/op
Iteration   1: 1.872 ±(99.9%) 0.011 ms/op
                 ...
                 existUser·p0.999:  4.635 ms/op
                 existUser·p0.9999: 5.300 ms/op
                 existUser·p1.00:   5.341 ms/op
...
Result "org.apache.dubbo.benchmark.Client.existUser":
  ...
  Percentiles, ms/op:
     ...
     p(99.9000) =      4.635 ms/op
     p(99.9900) =      5.300 ms/op
     p(99.9990) =      5.341 ms/op
     p(99.9999) =      5.341 ms/op
    p(100.0000) =      5.341 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.442 ±(99.9%) 0.106 ms/op
Iteration   1: 3.008 ±(99.9%) 0.023 ms/op
                 getUser·p0.00:   0.947 ms/op
                 getUser·p0.50:   2.937 ms/op
                 getUser·p0.90:   3.914 ms/op
                 getUser·p0.95:   4.235 ms/op
                 getUser·p0.99:   5.300 ms/op
                 getUser·p0.999:  6.077 ms/op
                 getUser·p0.9999: 9.837 ms/op
...
Result "org.apache.dubbo.benchmark.Client.getUser":
  ...
  Percentiles, ms/op:
     ...
     p(99.9000) =      6.077 ms/op
     p(99.9900) =      9.837 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.190 ±(99.9%) 0.446 ms/op
Iteration   1: 8.382 ±(99.9%) 0.120 ms/op
...
Client.createUser                      thrpt          5.624          ops/ms
Client.existUser                       thrpt         14.500          ops/ms
Client.getUser                         thrpt          7.347          ops/ms
...
Client.createUser                     sample  11016   3.048 ± 0.034   ms/op
Client.createUser:createUser·p0.00    sample          1.006           ms/op
Client.createUser:createUser·p0.50    sample          2.808           ms/op
Client.createUser:createUser·p0.90    sample          3.921           ms/op
Client.createUser:createUser·p0.95    sample          4.219           ms/op
Client.createUser:createUser·p0.99    sample          8.253           ms/op
Client.createUser:createUser·p0.999   sample         12.788           ms/op
Client.createUser:createUser·p0.9999  sample         13.992           ms/op
Client.createUser:createUser·p1.00    sample         13.992           ms/op
Client.existUser                      sample  17113   1.872 ± 0.011   ms/op
...
Client.existUser:existUser·p0.999     sample          4.635           ms/op
Client.existUser:existUser·p0.9999    sample          5.300           ms/op
Client.existUser:existUser·p1.00      sample          5.341           ms/op
Client.getUser                        sample  10593   3.008 ± 0.023   ms/op
Client.getUser:getUser·p0.00          sample          0.947           ms/op
Client.getUser:getUser·p0.50          sample          2.937           ms/op
Client.getUser:getUser·p0.90          sample          3.914           ms/op
Client.getUser:getUser·p0.95          sample          4.235           ms/op
Client.getUser:getUser·p0.99          sample          5.300           ms/op
Client.getUser:getUser·p0.999         sample          6.077           ms/op
Client.getUser:getUser·p0.9999        sample          9.837           ms/op
Client.getUser:getUser·p1.00          sample         10.027           ms/op
Client.listUser                       sample   3801   8.382 ± 0.120   ms/op
Client.listUser:listUser·p0.00        sample          3.723           ms/op
Client.listUser:listUser·p0.50        sample          7.930           ms/op
Client.listUser:listUser·p0.90        sample         11.154           ms/op
Client.listUser:listUser·p0.95        sample         12.190           ms/op
Client.listUser:listUser·p0.99        sample         17.197           ms/op
Client.listUser:listUser·p0.999       sample         20.264           ms/op
Client.listUser:listUser·p0.9999      sample         20.840           ms/op
Client.listUser:listUser·p1.00        sample         20.840           ms/op
```
