...
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.335 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  4.420 s
[INFO] Finished at: 2024-01-09T12:11:27Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.645 ±(99.9%) 0.106 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.759 ±(99.9%) 0.042 ms/op
Iteration   1: 1.988 ±(99.9%) 0.013 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.359 ±(99.9%) 0.046 ms/op
Iteration   1: 2.690 ±(99.9%) 0.007 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.842 ±(99.9%) 0.196 ms/op
Iteration   1: 7.698 ±(99.9%) 0.103 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.733 ±(99.9%) 0.100 ms/op
Iteration   1: 2.828 ±(99.9%) 0.027 ms/op
                 ...
                 createUser·p0.9999: 10.582 ms/op
...
Result "org.apache.dubbo.benchmark.Client.existUser":
  ...
  Percentiles, ms/op:
     ...
     p(95.0000) =      2.091 ms/op
     p(99.0000) =      3.482 ms/op
     p(99.9000) =     17.236 ms/op
     p(99.9900) =     17.306 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.255 ±(99.9%) 0.090 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.116 ±(99.9%) 0.388 ms/op
Iteration   1: 8.323 ±(99.9%) 0.108 ms/op
                 listUser·p0.00:   3.301 ms/op
                 listUser·p0.50:   8.053 ms/op
                 listUser·p0.90:   11.043 ms/op
                 listUser·p0.95:   12.034 ms/op
                 listUser·p0.99:   14.385 ms/op
                 listUser·p0.999:  19.412 ms/op
...
Result "org.apache.dubbo.benchmark.Client.listUser":
  ...
  Percentiles, ms/op:
     ...
     p(95.0000) =     12.034 ms/op
     p(99.0000) =     14.385 ms/op
     p(99.9000) =     19.412 ms/op
...
Client.createUser                      thrpt          6.400          ops/ms
Client.existUser                       thrpt         12.604          ops/ms
Client.getUser                         thrpt          9.835          ops/ms
...
Client.listUser                         avgt          7.698           ms/op
Client.createUser                     sample  11446   2.828 ± 0.027   ms/op
...
Client.createUser:createUser·p0.99    sample          6.898           ms/op
Client.createUser:createUser·p0.999   sample          9.423           ms/op
Client.createUser:createUser·p0.9999  sample         10.582           ms/op
Client.createUser:createUser·p1.00    sample         10.584           ms/op
Client.existUser                      sample  19381   1.656 ± 0.020   ms/op
Client.existUser:existUser·p0.00      sample          0.668           ms/op
Client.existUser:existUser·p0.50      sample          1.540           ms/op
Client.existUser:existUser·p0.90      sample          1.937           ms/op
Client.existUser:existUser·p0.95      sample          2.091           ms/op
Client.existUser:existUser·p0.99      sample          3.482           ms/op
Client.existUser:existUser·p0.999     sample         17.236           ms/op
Client.existUser:existUser·p0.9999    sample         17.306           ms/op
Client.existUser:existUser·p1.00      sample         17.367           ms/op
Client.getUser                        sample   9924   3.218 ± 0.026   ms/op
Client.getUser:getUser·p0.00          sample          0.935           ms/op
Client.getUser:getUser·p0.50          sample          3.174           ms/op
Client.getUser:getUser·p0.90          sample          3.871           ms/op
Client.getUser:getUser·p0.95          sample          4.132           ms/op
Client.getUser:getUser·p0.99          sample          5.736           ms/op
Client.getUser:getUser·p0.999         sample         11.022           ms/op
Client.getUser:getUser·p0.9999        sample         11.682           ms/op
Client.getUser:getUser·p1.00          sample         11.682           ms/op
Client.listUser                       sample   3849   8.323 ± 0.108   ms/op
Client.listUser:listUser·p0.00        sample          3.301           ms/op
Client.listUser:listUser·p0.50        sample          8.053           ms/op
Client.listUser:listUser·p0.90        sample         11.043           ms/op
Client.listUser:listUser·p0.95        sample         12.034           ms/op
Client.listUser:listUser·p0.99        sample         14.385           ms/op
Client.listUser:listUser·p0.999       sample         19.412           ms/op
