...
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.325 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.099 ±(99.9%) 0.057 ms/op
Iteration   1: 3.201 ±(99.9%) 0.016 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 2.894 ±(99.9%) 0.031 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.245 ±(99.9%) 0.049 ms/op
Iteration   1: 3.227 ±(99.9%) 0.016 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.413 ±(99.9%) 0.258 ms/op
Iteration   1: 8.197 ±(99.9%) 0.093 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.991 ±(99.9%) 0.123 ms/op
Iteration   1: 2.787 ±(99.9%) 0.038 ms/op
                 ...
                 createUser·p0.9999: 19.744 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.156 ±(99.9%) 0.085 ms/op
Iteration   1: 1.850 ±(99.9%) 0.010 ms/op
                 ...
                 existUser·p0.999:  3.853 ms/op
                 existUser·p0.9999: 4.518 ms/op
                 existUser·p1.00:   4.530 ms/op



Result "org.apache.dubbo.benchmark.Client.existUser":
  N = 17280
  mean =      1.850 ±(99.9%) 0.010 ms/op
  ...
  Percentiles, ms/op:
     ...
     p(99.9000) =      3.853 ms/op
     p(99.9900) =      4.518 ms/op
     p(99.9990) =      4.530 ms/op
     p(99.9999) =      4.530 ms/op
    p(100.0000) =      4.530 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.477 ±(99.9%) 0.097 ms/op
Iteration   1: 3.178 ±(99.9%) 0.025 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.853 ±(99.9%) 0.377 ms/op
Iteration   1: 9.273 ±(99.9%) 0.154 ms/op
                 listUser·p0.00:   1.827 ms/op
                 listUser·p0.50:   9.175 ms/op
                 listUser·p0.90:   12.714 ms/op
                 listUser·p0.95:   13.976 ms/op
                 listUser·p0.99:   16.038 ms/op
                 listUser·p0.999:  23.007 ms/op
...
Client.createUser                      thrpt          5.827          ops/ms
Client.existUser                       thrpt         13.360          ops/ms
Client.getUser                         thrpt          9.404          ops/ms
Client.listUser                        thrpt          3.789          ops/ms
Client.createUser                       avgt          3.201           ms/op
Client.existUser                        avgt          2.074           ms/op
Client.getUser                          avgt          3.227           ms/op
Client.listUser                         avgt          8.197           ms/op
Client.createUser                     sample  11471   2.787 ± 0.038   ms/op
...
Client.createUser:createUser·p0.95    sample          3.629           ms/op
Client.createUser:createUser·p0.99    sample         10.289           ms/op
Client.createUser:createUser·p0.999   sample         18.285           ms/op
Client.createUser:createUser·p0.9999  sample         19.744           ms/op
Client.createUser:createUser·p1.00    sample         19.792           ms/op
Client.existUser                      sample  17280   1.850 ± 0.010   ms/op
...
Client.existUser:existUser·p0.999     sample          3.853           ms/op
Client.existUser:existUser·p0.9999    sample          4.518           ms/op
Client.existUser:existUser·p1.00      sample          4.530           ms/op
Client.getUser                        sample  10063   3.178 ± 0.025   ms/op
...
Client.getUser:getUser·p0.999         sample          8.888           ms/op
Client.getUser:getUser·p0.9999        sample         10.174           ms/op
Client.getUser:getUser·p1.00          sample         10.174           ms/op
Client.listUser                       sample   3455   9.273 ± 0.154   ms/op
Client.listUser:listUser·p0.00        sample          1.827           ms/op
Client.listUser:listUser·p0.50        sample          9.175           ms/op
Client.listUser:listUser·p0.90        sample         12.714           ms/op
Client.listUser:listUser·p0.95        sample         13.976           ms/op
Client.listUser:listUser·p0.99        sample         16.038           ms/op
Client.listUser:listUser·p0.999       sample         23.007           ms/op
