...
[INFO] 
[INFO] benchmark-base ..................................... SUCCESS [  3.016 s]
[INFO] server-base ........................................ SUCCESS [  0.293 s]
[INFO] client-base ........................................ SUCCESS [  0.556 s]
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.288 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  4.451 s
[INFO] Finished at: 2023-12-12T00:30:47Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.206 ±(99.9%) 0.076 ms/op
Iteration   1: 2.981 ±(99.9%) 0.012 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 2.972 ±(99.9%) 0.034 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.197 ±(99.9%) 0.068 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.998 ±(99.9%) 0.207 ms/op
Iteration   1: 8.371 ±(99.9%) 0.130 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.471 ±(99.9%) 0.135 ms/op
Iteration   1: 3.211 ±(99.9%) 0.024 ms/op
                 ...
                 createUser·p0.9999: 8.602 ms/op
                 createUser·p1.00:   8.602 ms/op



Result "org.apache.dubbo.benchmark.Client.createUser":
  N = 9947
  mean =      3.211 ±(99.9%) 0.024 ms/op
...
Iteration   1: 2.011 ±(99.9%) 0.013 ms/op
                 ...
                 existUser·p0.999:  4.575 ms/op
                 existUser·p0.9999: 5.478 ms/op
                 existUser·p1.00:   5.505 ms/op



Result "org.apache.dubbo.benchmark.Client.existUser":
  N = 16506
  mean =      2.011 ±(99.9%) 0.013 ms/op
  ...
  Percentiles, ms/op:
     ...
     p(99.9000) =      4.575 ms/op
     p(99.9900) =      5.478 ms/op
     p(99.9990) =      5.505 ms/op
     p(99.9999) =      5.505 ms/op
    p(100.0000) =      5.505 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.665 ±(99.9%) 0.168 ms/op
...
Client.existUser                       thrpt         14.764          ops/ms
Client.getUser                         thrpt          9.153          ops/ms
...
Client.listUser                         avgt          8.371           ms/op
Client.createUser                     sample   9947   3.211 ± 0.024   ms/op
...
Client.createUser:createUser·p0.99    sample          6.177           ms/op
Client.createUser:createUser·p0.999   sample          8.406           ms/op
Client.createUser:createUser·p0.9999  sample          8.602           ms/op
Client.createUser:createUser·p1.00    sample          8.602           ms/op
Client.existUser                      sample  16506   2.011 ± 0.013   ms/op
Client.existUser:existUser·p0.00      sample          0.760           ms/op
Client.existUser:existUser·p0.50      sample          1.921           ms/op
Client.existUser:existUser·p0.90      sample          2.748           ms/op
Client.existUser:existUser·p0.95      sample          3.002           ms/op
Client.existUser:existUser·p0.99      sample          3.453           ms/op
Client.existUser:existUser·p0.999     sample          4.575           ms/op
Client.existUser:existUser·p0.9999    sample          5.478           ms/op
Client.existUser:existUser·p1.00      sample          5.505           ms/op
Client.getUser                        sample   9680   3.312 ± 0.035   ms/op
Client.getUser:getUser·p0.00          sample          0.999           ms/op
Client.getUser:getUser·p0.50          sample          3.219           ms/op
Client.getUser:getUser·p0.90          sample          4.141           ms/op
Client.getUser:getUser·p0.95          sample          4.497           ms/op
Client.getUser:getUser·p0.99          sample          6.950           ms/op
Client.getUser:getUser·p0.999         sample         13.031           ms/op
Client.getUser:getUser·p0.9999        sample         13.337           ms/op
Client.getUser:getUser·p1.00          sample         13.337           ms/op
Client.listUser                       sample   3578   8.988 ± 0.120   ms/op
...
Client.listUser:listUser·p0.95        sample         12.813           ms/op
Client.listUser:listUser·p0.99        sample         14.815           ms/op
Client.listUser:listUser·p0.999       sample         18.654           ms/op
