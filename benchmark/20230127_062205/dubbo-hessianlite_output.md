...
16.261 ±(99.9%) 0.532 ms/op
                 ...
                 createUser·p0.50:   14.500 ms/op
                 createUser·p0.90:   26.326 ms/op
                 createUser·p0.95:   30.815 ms/op
                 createUser·p0.99:   45.416 ms/op
                 createUser·p0.999:  56.980 ms/op
                 createUser·p0.9999: 61.538 ms/op
                 createUser·p1.00:   61.538 ms/op
...
7.896 ±(99.9%) 0.171 ms/op
                 ...
                 existUser·p0.90:   10.338 ms/op
                 existUser·p0.95:   12.059 ms/op
                 existUser·p0.99:   22.443 ms/op
                 existUser·p0.999:  34.535 ms/op
...
10.516 ±(99.9%) 0.284 ms/op
                 getUser·p0.00:   4.489 ms/op
                 getUser·p0.50:   9.560 ms/op
                 getUser·p0.90:   16.548 ms/op
                 getUser·p0.95:   17.932 ms/op
                 getUser·p0.99:   35.281 ms/op
                 getUser·p0.999:  39.515 ms/op
...
32.781 ±(99.9%) 0.752 ms/op
                 ...
                 listUser·p0.50:   31.883 ms/op
                 listUser·p0.90:   42.795 ms/op
                 listUser·p0.95:   45.633 ms/op
                 listUser·p0.99:   48.562 ms/op
                 listUser·p0.999:  52.822 ms/op
...
Client.createUser:createUser·p0.50    sample        14.500           ms/op
Client.createUser:createUser·p0.90    sample        26.326           ms/op
Client.createUser:createUser·p0.95    sample        30.815           ms/op
Client.createUser:createUser·p0.99    sample        45.416           ms/op
Client.createUser:createUser·p0.999   sample        56.980           ms/op
Client.createUser:createUser·p0.9999  sample        61.538           ms/op
Client.createUser:createUser·p1.00    sample        61.538           ms/op
Client.existUser                      sample  4009   7.896 ± 0.171   ms/op
Client.existUser:existUser·p0.00      sample         1.303           ms/op
Client.existUser:existUser·p0.50      sample         7.012           ms/op
Client.existUser:existUser·p0.90      sample        10.338           ms/op
Client.existUser:existUser·p0.95      sample        12.059           ms/op
Client.existUser:existUser·p0.99      sample        22.443           ms/op
Client.existUser:existUser·p0.999     sample        34.535           ms/op
...
Client.getUser:getUser·p0.00          sample         4.489           ms/op
Client.getUser:getUser·p0.50          sample         9.560           ms/op
Client.getUser:getUser·p0.90          sample        16.548           ms/op
Client.getUser:getUser·p0.95          sample        17.932           ms/op
Client.getUser:getUser·p0.99          sample        35.281           ms/op
Client.getUser:getUser·p0.999         sample        39.515           ms/op
...
Client.listUser:listUser·p0.50        sample        31.883           ms/op
Client.listUser:listUser·p0.90        sample        42.795           ms/op
Client.listUser:listUser·p0.95        sample        45.633           ms/op
Client.listUser:listUser·p0.99        sample        48.562           ms/op
Client.listUser:listUser·p0.999       sample        52.822           ms/op
