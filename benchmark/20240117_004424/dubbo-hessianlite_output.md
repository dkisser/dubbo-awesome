...
[INFO] 
[INFO] benchmark-base ..................................... SUCCESS [  2.864 s]
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.945 ±(99.9%) 0.085 ms/op
Iteration   1: 3.348 ±(99.9%) 0.012 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.037 ±(99.9%) 0.031 ms/op
Iteration   1: 1.903 ±(99.9%) 0.009 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.071 ±(99.9%) 0.070 ms/op
Iteration   1: 3.149 ±(99.9%) 0.017 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 13.076 ±(99.9%) 0.334 ms/op
Iteration   1: 9.360 ±(99.9%) 0.104 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.160 ±(99.9%) 0.115 ms/op
Iteration   1: 2.748 ±(99.9%) 0.022 ms/op
                 ...
                 createUser·p0.9999: 10.082 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 2.785 ±(99.9%) 0.063 ms/op
Iteration   1: 1.864 ±(99.9%) 0.021 ms/op
                 existUser·p0.00:   0.560 ms/op
                 existUser·p0.50:   1.789 ms/op
                 existUser·p0.90:   2.458 ms/op
                 existUser·p0.95:   2.695 ms/op
                 existUser·p0.99:   3.558 ms/op
                 existUser·p0.999:  16.671 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 14.090 ±(99.9%) 0.686 ms/op
Iteration   1: 9.199 ±(99.9%) 0.138 ms/op
...
Client.createUser                      thrpt          5.844          ops/ms
Client.existUser                       thrpt         13.958          ops/ms
Client.getUser                         thrpt          8.776          ops/ms
Client.listUser                        thrpt          3.211          ops/ms
Client.createUser                       avgt          3.348           ms/op
Client.existUser                        avgt          1.903           ms/op
Client.getUser                          avgt          3.149           ms/op
Client.listUser                         avgt          9.360           ms/op
Client.createUser                     sample  11661   2.748 ± 0.022   ms/op
Client.createUser:createUser·p0.00    sample          1.454           ms/op
Client.createUser:createUser·p0.50    sample          2.646           ms/op
Client.createUser:createUser·p0.90    sample          3.113           ms/op
Client.createUser:createUser·p0.95    sample          3.359           ms/op
Client.createUser:createUser·p0.99    sample          6.934           ms/op
Client.createUser:createUser·p0.999   sample          9.388           ms/op
Client.createUser:createUser·p0.9999  sample         10.082           ms/op
Client.createUser:createUser·p1.00    sample         10.093           ms/op
Client.existUser                      sample  17228   1.864 ± 0.021   ms/op
Client.existUser:existUser·p0.00      sample          0.560           ms/op
Client.existUser:existUser·p0.50      sample          1.789           ms/op
Client.existUser:existUser·p0.90      sample          2.458           ms/op
Client.existUser:existUser·p0.95      sample          2.695           ms/op
Client.existUser:existUser·p0.99      sample          3.558           ms/op
Client.existUser:existUser·p0.999     sample         16.671           ms/op
Client.existUser:existUser·p0.9999    sample         17.683           ms/op
Client.existUser:existUser·p1.00      sample         18.252           ms/op
Client.getUser                        sample   8837   3.619 ± 0.029   ms/op
Client.getUser:getUser·p0.00          sample          0.992           ms/op
Client.getUser:getUser·p0.50          sample          3.572           ms/op
Client.getUser:getUser·p0.90          sample          4.630           ms/op
Client.getUser:getUser·p0.95          sample          5.120           ms/op
Client.getUser:getUser·p0.99          sample          5.923           ms/op
Client.getUser:getUser·p0.999         sample          7.243           ms/op
Client.getUser:getUser·p0.9999        sample          9.634           ms/op
Client.getUser:getUser·p1.00          sample          9.634           ms/op
Client.listUser                       sample   3558   9.199 ± 0.138   ms/op
Client.listUser:listUser·p0.00        sample          2.015           ms/op
Client.listUser:listUser·p0.50        sample          8.946           ms/op
Client.listUser:listUser·p0.90        sample         12.321           ms/op
Client.listUser:listUser·p0.95        sample         14.025           ms/op
Client.listUser:listUser·p0.99        sample         16.739           ms/op
Client.listUser:listUser·p0.999       sample         20.606           ms/op
Client.listUser:listUser·p0.9999      sample         24.084           ms/op
Client.listUser:listUser·p1.00        sample         24.084           ms/op
```
