...
[INFO] 
[INFO] benchmark-base ..................................... SUCCESS [  2.900 s]
[INFO] server-base ........................................ SUCCESS [  0.308 s]
[INFO] client-base ........................................ SUCCESS [  0.656 s]
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.382 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  4.576 s
[INFO] Finished at: 2023-12-17T00:33:02Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.395 ±(99.9%) 0.086 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.111 ±(99.9%) 0.043 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.742 ±(99.9%) 0.056 ms/op
Iteration   1: 2.851 ±(99.9%) 0.016 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.799 ±(99.9%) 0.219 ms/op
Iteration   1: 8.566 ±(99.9%) 0.080 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.514 ±(99.9%) 0.076 ms/op
...
Result "org.apache.dubbo.benchmark.Client.existUser":
  ...
  Percentiles, ms/op:
     ...
     p(99.9000) =      6.019 ms/op
     p(99.9900) =      6.517 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.892 ±(99.9%) 0.110 ms/op
Iteration   1: 3.311 ±(99.9%) 0.046 ms/op
                 getUser·p0.00:   1.114 ms/op
                 getUser·p0.50:   3.185 ms/op
                 getUser·p0.90:   4.030 ms/op
                 getUser·p0.95:   4.383 ms/op
                 getUser·p0.99:   7.306 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.103 ±(99.9%) 0.492 ms/op
Iteration   1: 8.031 ±(99.9%) 0.132 ms/op
                 listUser·p0.00:   2.908 ms/op
                 listUser·p0.50:   7.668 ms/op
                 listUser·p0.90:   10.269 ms/op
                 listUser·p0.95:   11.534 ms/op
                 listUser·p0.99:   21.340 ms/op
                 listUser·p0.999:  23.890 ms/op
...
Client.existUser                       thrpt         13.907          ops/ms
Client.getUser                         thrpt          9.565          ops/ms
...
Client.listUser                         avgt          8.566           ms/op
Client.createUser                     sample  10037   3.174 ± 0.057   ms/op
Client.createUser:createUser·p0.00    sample          0.900           ms/op
Client.createUser:createUser·p0.50    sample          2.822           ms/op
Client.createUser:createUser·p0.90    sample          4.171           ms/op
Client.createUser:createUser·p0.95    sample          4.555           ms/op
Client.createUser:createUser·p0.99    sample          9.365           ms/op
Client.createUser:createUser·p0.999   sample         24.740           ms/op
Client.createUser:createUser·p0.9999  sample         25.491           ms/op
Client.createUser:createUser·p1.00    sample         25.494           ms/op
Client.existUser                      sample  17081   1.872 ± 0.011   ms/op
...
Client.existUser:existUser·p0.99      sample          3.110           ms/op
Client.existUser:existUser·p0.999     sample          6.019           ms/op
Client.existUser:existUser·p0.9999    sample          6.517           ms/op
Client.existUser:existUser·p1.00      sample          6.668           ms/op
Client.getUser                        sample   9668   3.311 ± 0.046   ms/op
Client.getUser:getUser·p0.00          sample          1.114           ms/op
Client.getUser:getUser·p0.50          sample          3.185           ms/op
Client.getUser:getUser·p0.90          sample          4.030           ms/op
Client.getUser:getUser·p0.95          sample          4.383           ms/op
Client.getUser:getUser·p0.99          sample          7.306           ms/op
Client.getUser:getUser·p0.999         sample         21.277           ms/op
Client.getUser:getUser·p0.9999        sample         23.101           ms/op
Client.getUser:getUser·p1.00          sample         23.101           ms/op
Client.listUser                       sample   3981   8.031 ± 0.132   ms/op
Client.listUser:listUser·p0.00        sample          2.908           ms/op
Client.listUser:listUser·p0.50        sample          7.668           ms/op
Client.listUser:listUser·p0.90        sample         10.269           ms/op
Client.listUser:listUser·p0.95        sample         11.534           ms/op
Client.listUser:listUser·p0.99        sample         21.340           ms/op
Client.listUser:listUser·p0.999       sample         23.890           ms/op
