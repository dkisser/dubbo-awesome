...
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.351 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  4.503 s
[INFO] Finished at: 2023-12-05T18:08:28Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.692 ±(99.9%) 0.077 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.356 ±(99.9%) 0.039 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.057 ±(99.9%) 0.056 ms/op
Iteration   1: 2.946 ±(99.9%) 0.012 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.276 ±(99.9%) 0.209 ms/op
Iteration   1: 7.832 ±(99.9%) 0.087 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.889 ±(99.9%) 0.107 ms/op
Iteration   1: 3.020 ±(99.9%) 0.026 ms/op
                 ...
                 createUser·p0.999:  9.575 ms/op
                 createUser·p0.9999: 10.045 ms/op
                 createUser·p1.00:   10.060 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.566 ±(99.9%) 0.087 ms/op
Iteration   1: 2.020 ±(99.9%) 0.015 ms/op
                 existUser·p0.00:   0.741 ms/op
                 existUser·p0.50:   1.974 ms/op
                 existUser·p0.90:   2.662 ms/op
                 existUser·p0.95:   2.875 ms/op
                 existUser·p0.99:   3.587 ms/op
                 existUser·p0.999:  4.818 ms/op
                 existUser·p0.9999: 5.277 ms/op
                 existUser·p1.00:   5.358 ms/op



Result "org.apache.dubbo.benchmark.Client.existUser":
  N = 15812
  mean =      2.020 ±(99.9%) 0.015 ms/op
  ...
  Percentiles, ms/op:
     ...
     p(99.9000) =      4.818 ms/op
     p(99.9900) =      5.277 ms/op
     p(99.9990) =      5.358 ms/op
     p(99.9999) =      5.358 ms/op
    p(100.0000) =      5.358 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.449 ±(99.9%) 0.103 ms/op
Iteration   1: 2.946 ±(99.9%) 0.024 ms/op
...
Client.createUser                      thrpt          6.781          ops/ms
Client.existUser                       thrpt         13.627          ops/ms
Client.getUser                         thrpt          7.869          ops/ms
Client.listUser                        thrpt          3.847          ops/ms
Client.createUser                       avgt          3.164           ms/op
Client.existUser                        avgt          1.939           ms/op
Client.getUser                          avgt          2.946           ms/op
Client.listUser                         avgt          7.832           ms/op
Client.createUser                     sample  10597   3.020 ± 0.026   ms/op
Client.createUser:createUser·p0.00    sample          0.766           ms/op
...
Client.createUser:createUser·p0.99    sample          6.275           ms/op
Client.createUser:createUser·p0.999   sample          9.575           ms/op
Client.createUser:createUser·p0.9999  sample         10.045           ms/op
Client.createUser:createUser·p1.00    sample         10.060           ms/op
Client.existUser                      sample  15812   2.020 ± 0.015   ms/op
Client.existUser:existUser·p0.00      sample          0.741           ms/op
...
Client.existUser:existUser·p0.99      sample          3.587           ms/op
Client.existUser:existUser·p0.999     sample          4.818           ms/op
Client.existUser:existUser·p0.9999    sample          5.277           ms/op
Client.existUser:existUser·p1.00      sample          5.358           ms/op
Client.getUser                        sample  10834   2.946 ± 0.024   ms/op
...
Client.getUser:getUser·p0.999         sample          7.893           ms/op
Client.getUser:getUser·p0.9999        sample          8.682           ms/op
Client.getUser:getUser·p1.00          sample          8.684           ms/op
Client.listUser                       sample   4602   7.061 ± 0.109   ms/op
Client.listUser:listUser·p0.00        sample          1.575           ms/op
Client.listUser:listUser·p0.50        sample          6.717           ms/op
Client.listUser:listUser·p0.90        sample          9.241           ms/op
Client.listUser:listUser·p0.95        sample         10.156           ms/op
Client.listUser:listUser·p0.99        sample         15.922           ms/op
