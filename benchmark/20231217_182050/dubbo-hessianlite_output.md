...
[INFO] client-base ........................................ SUCCESS [  0.527 s]
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.360 ops/ms
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.198 ±(99.9%) 0.093 ms/op
Iteration   1: 2.739 ±(99.9%) 0.025 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 2.907 ±(99.9%) 0.032 ms/op
Iteration   1: 1.899 ±(99.9%) 0.010 ms/op
...
Iteration   1: 2.975 ±(99.9%) 0.013 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.515 ±(99.9%) 0.257 ms/op
Iteration   1: 8.605 ±(99.9%) 0.128 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.885 ±(99.9%) 0.106 ms/op
Iteration   1: 3.297 ±(99.9%) 0.056 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.039 ±(99.9%) 0.064 ms/op
Iteration   1: 1.864 ±(99.9%) 0.071 ms/op
                 existUser·p0.00:   0.795 ms/op
                 existUser·p0.50:   1.608 ms/op
                 existUser·p0.90:   2.351 ms/op
                 existUser·p0.95:   2.713 ms/op
                 existUser·p0.99:   3.408 ms/op
                 existUser·p0.999:  64.073 ms/op
                 existUser·p0.9999: 75.909 ms/op
                 existUser·p1.00:   76.284 ms/op



Result "org.apache.dubbo.benchmark.Client.existUser":
  N = 17151
  mean =      1.864 ±(99.9%) 0.071 ms/op
  ...
  Percentiles, ms/op:
     ...
     p(95.0000) =      2.713 ms/op
     p(99.0000) =      3.408 ms/op
     p(99.9000) =     64.073 ms/op
     p(99.9900) =     75.909 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.308 ±(99.9%) 0.091 ms/op
...
Result "org.apache.dubbo.benchmark.Client.getUser":
  ...
  Percentiles, ms/op:
     ...
     p(99.0000) =      4.750 ms/op
     p(99.9000) =     14.107 ms/op
     p(99.9900) =     15.186 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.821 ±(99.9%) 0.428 ms/op
Iteration   1: 8.358 ±(99.9%) 0.124 ms/op
                 listUser·p0.00:   2.875 ms/op
                 listUser·p0.50:   8.020 ms/op
                 listUser·p0.90:   11.334 ms/op
                 listUser·p0.95:   12.442 ms/op
...
Client.createUser                      thrpt          7.100          ops/ms
Client.existUser                       thrpt         11.935          ops/ms
Client.getUser                         thrpt          8.458          ops/ms
Client.listUser                        thrpt          3.786          ops/ms
Client.createUser                       avgt          2.739           ms/op
Client.existUser                        avgt          1.899           ms/op
Client.getUser                          avgt          2.975           ms/op
Client.listUser                         avgt          8.605           ms/op
Client.createUser                     sample   9803   3.297 ± 0.056   ms/op
...
Client.createUser:createUser·p0.999   sample         24.615           ms/op
Client.createUser:createUser·p0.9999  sample         25.919           ms/op
Client.createUser:createUser·p1.00    sample         25.919           ms/op
Client.existUser                      sample  17151   1.864 ± 0.071   ms/op
Client.existUser:existUser·p0.00      sample          0.795           ms/op
Client.existUser:existUser·p0.50      sample          1.608           ms/op
Client.existUser:existUser·p0.90      sample          2.351           ms/op
Client.existUser:existUser·p0.95      sample          2.713           ms/op
Client.existUser:existUser·p0.99      sample          3.408           ms/op
Client.existUser:existUser·p0.999     sample         64.073           ms/op
Client.existUser:existUser·p0.9999    sample         75.909           ms/op
Client.existUser:existUser·p1.00      sample         76.284           ms/op
Client.getUser                        sample  10909   2.935 ± 0.026   ms/op
...
Client.getUser:getUser·p0.99          sample          4.750           ms/op
Client.getUser:getUser·p0.999         sample         14.107           ms/op
Client.getUser:getUser·p0.9999        sample         15.186           ms/op
Client.getUser:getUser·p1.00          sample         15.188           ms/op
Client.listUser                       sample   3831   8.358 ± 0.124   ms/op
Client.listUser:listUser·p0.00        sample          2.875           ms/op
Client.listUser:listUser·p0.50        sample          8.020           ms/op
Client.listUser:listUser·p0.90        sample         11.334           ms/op
Client.listUser:listUser·p0.95        sample         12.442           ms/op
Client.listUser:listUser·p0.99        sample         15.909           ms/op
Client.listUser:listUser·p0.999       sample         20.453           ms/op
