...
[INFO] 
[INFO] benchmark-base ..................................... SUCCESS [  2.998 s]
[INFO] server-base ........................................ SUCCESS [  0.364 s]
[INFO] client-base ........................................ SUCCESS [  0.728 s]
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.513 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  4.939 s
[INFO] Finished at: 2024-02-02T06:08:37Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.745 ±(99.9%) 0.075 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.177 ±(99.9%) 0.033 ms/op
Iteration   1: 1.912 ±(99.9%) 0.006 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.931 ±(99.9%) 0.066 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.056 ±(99.9%) 0.167 ms/op
Iteration   1: 9.480 ±(99.9%) 0.124 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.341 ±(99.9%) 0.122 ms/op
Iteration   1: 2.994 ±(99.9%) 0.035 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.387 ±(99.9%) 0.089 ms/op
Iteration   1: 1.776 ±(99.9%) 0.025 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.617 ±(99.9%) 0.109 ms/op
Iteration   1: 2.687 ±(99.9%) 0.022 ms/op
                 getUser·p0.00:   0.942 ms/op
                 getUser·p0.50:   2.482 ms/op
                 getUser·p0.90:   3.518 ms/op
                 getUser·p0.95:   3.872 ms/op
                 getUser·p0.99:   5.035 ms/op
                 getUser·p0.999:  8.538 ms/op
                 getUser·p0.9999: 8.833 ms/op
...
Result "org.apache.dubbo.benchmark.Client.getUser":
  ...
  Percentiles, ms/op:
     ...
     p(95.0000) =      3.872 ms/op
     p(99.0000) =      5.035 ms/op
     p(99.9000) =      8.538 ms/op
     p(99.9900) =      8.833 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.845 ±(99.9%) 0.437 ms/op
Iteration   1: 8.153 ±(99.9%) 0.362 ms/op
                 listUser·p0.00:   1.917 ms/op
                 listUser·p0.50:   7.274 ms/op
                 listUser·p0.90:   10.060 ms/op
                 listUser·p0.95:   11.787 ms/op
                 listUser·p0.99:   19.657 ms/op
                 listUser·p0.999:  99.649 ms/op
                 listUser·p0.9999: 105.775 ms/op
                 listUser·p1.00:   105.775 ms/op



Result "org.apache.dubbo.benchmark.Client.listUser":
  N = 3911
  mean =      8.153 ±(99.9%) 0.362 ms/op
  ...
  Percentiles, ms/op:
     ...
     p(95.0000) =     11.787 ms/op
     p(99.0000) =     19.657 ms/op
     p(99.9000) =     99.649 ms/op
...
Client.createUser                      thrpt           5.409          ops/ms
Client.existUser                       thrpt          13.539          ops/ms
Client.getUser                         thrpt           6.890          ops/ms
Client.listUser                        thrpt           3.696          ops/ms
Client.createUser                       avgt           3.524           ms/op
Client.existUser                        avgt           1.912           ms/op
Client.getUser                          avgt           3.088           ms/op
Client.listUser                         avgt           9.480           ms/op
Client.createUser                     sample  10731    2.994 ± 0.035   ms/op
...
Client.createUser:createUser·p0.99    sample           8.007           ms/op
Client.createUser:createUser·p0.999   sample          12.953           ms/op
Client.createUser:createUser·p0.9999  sample          14.189           ms/op
Client.createUser:createUser·p1.00    sample          14.189           ms/op
Client.existUser                      sample  17985    1.776 ± 0.025   ms/op
...
Client.existUser:existUser·p0.99      sample           3.556           ms/op
Client.existUser:existUser·p0.999     sample          17.925           ms/op
Client.existUser:existUser·p0.9999    sample          18.121           ms/op
Client.existUser:existUser·p1.00      sample          18.121           ms/op
Client.getUser                        sample  11893    2.687 ± 0.022   ms/op
Client.getUser:getUser·p0.00          sample           0.942           ms/op
Client.getUser:getUser·p0.50          sample           2.482           ms/op
Client.getUser:getUser·p0.90          sample           3.518           ms/op
Client.getUser:getUser·p0.95          sample           3.872           ms/op
Client.getUser:getUser·p0.99          sample           5.035           ms/op
Client.getUser:getUser·p0.999         sample           8.538           ms/op
Client.getUser:getUser·p0.9999        sample           8.833           ms/op
Client.getUser:getUser·p1.00          sample           8.864           ms/op
Client.listUser                       sample   3911    8.153 ± 0.362   ms/op
Client.listUser:listUser·p0.00        sample           1.917           ms/op
Client.listUser:listUser·p0.50        sample           7.274           ms/op
Client.listUser:listUser·p0.90        sample          10.060           ms/op
Client.listUser:listUser·p0.95        sample          11.787           ms/op
Client.listUser:listUser·p0.99        sample          19.657           ms/op
Client.listUser:listUser·p0.999       sample          99.649           ms/op
Client.listUser:listUser·p0.9999      sample         105.775           ms/op
Client.listUser:listUser·p1.00        sample         105.775           ms/op
```
