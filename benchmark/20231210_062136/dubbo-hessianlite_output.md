...
[INFO] 
[INFO] benchmark-base ..................................... SUCCESS [  3.026 s]
[INFO] server-base ........................................ SUCCESS [  0.355 s]
[INFO] client-base ........................................ SUCCESS [  0.680 s]
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.477 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  4.850 s
[INFO] Finished at: 2023-12-10T06:08:05Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.436 ±(99.9%) 0.078 ms/op
Iteration   1: 2.946 ±(99.9%) 0.009 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.013 ±(99.9%) 0.032 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.041 ±(99.9%) 0.062 ms/op
Iteration   1: 3.051 ±(99.9%) 0.012 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.754 ±(99.9%) 0.329 ms/op
Iteration   1: 8.230 ±(99.9%) 0.103 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.062 ±(99.9%) 0.109 ms/op
Iteration   1: 3.009 ±(99.9%) 0.040 ms/op
                 ...
                 createUser·p0.9999: 15.678 ms/op
...
Result "org.apache.dubbo.benchmark.Client.createUser":
  ...
  Percentiles, ms/op:
     ...
     p(99.0000) =     10.202 ms/op
     p(99.9000) =     15.522 ms/op
     p(99.9900) =     15.678 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.505 ±(99.9%) 0.115 ms/op
Iteration   1: 2.093 ±(99.9%) 0.017 ms/op
                 ...
                 existUser·p0.9999: 10.443 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.123 ±(99.9%) 0.099 ms/op
Iteration   1: 3.365 ±(99.9%) 0.224 ms/op
                 getUser·p0.00:   0.626 ms/op
                 getUser·p0.50:   2.699 ms/op
                 getUser·p0.90:   3.715 ms/op
                 getUser·p0.95:   4.100 ms/op
                 getUser·p0.99:   8.568 ms/op
                 getUser·p0.999:  106.955 ms/op
                 getUser·p0.9999: 111.411 ms/op
                 getUser·p1.00:   111.411 ms/op



Result "org.apache.dubbo.benchmark.Client.getUser":
  N = 9502
  mean =      3.365 ±(99.9%) 0.224 ms/op
  ...
  Percentiles, ms/op:
     ...
     p(99.9900) =    111.411 ms/op
     p(99.9990) =    111.411 ms/op
     p(99.9999) =    111.411 ms/op
    p(100.0000) =    111.411 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.266 ±(99.9%) 0.483 ms/op
Iteration   1: 7.327 ±(99.9%) 0.092 ms/op
                 listUser·p0.00:   2.744 ms/op
                 listUser·p0.50:   7.086 ms/op
                 listUser·p0.90:   9.362 ms/op
                 listUser·p0.95:   10.306 ms/op
                 listUser·p0.99:   12.970 ms/op
                 listUser·p0.999:  18.893 ms/op
...
Client.createUser                      thrpt           5.581          ops/ms
Client.existUser                       thrpt          11.170          ops/ms
Client.getUser                         thrpt           8.832          ops/ms
Client.listUser                        thrpt           3.657          ops/ms
Client.createUser                       avgt           2.946           ms/op
Client.existUser                        avgt           1.846           ms/op
Client.getUser                          avgt           3.051           ms/op
Client.listUser                         avgt           8.230           ms/op
Client.createUser                     sample  10628    3.009 ± 0.040   ms/op
Client.createUser:createUser·p0.00    sample           0.911           ms/op
...
Client.createUser:createUser·p0.99    sample          10.202           ms/op
Client.createUser:createUser·p0.999   sample          15.522           ms/op
Client.createUser:createUser·p0.9999  sample          15.678           ms/op
Client.createUser:createUser·p1.00    sample          15.679           ms/op
Client.existUser                      sample  15273    2.093 ± 0.017   ms/op
Client.existUser:existUser·p0.00      sample           0.578           ms/op
Client.existUser:existUser·p0.50      sample           2.034           ms/op
Client.existUser:existUser·p0.90      sample           2.675           ms/op
Client.existUser:existUser·p0.95      sample           3.052           ms/op
Client.existUser:existUser·p0.99      sample           4.850           ms/op
Client.existUser:existUser·p0.999     sample           6.445           ms/op
Client.existUser:existUser·p0.9999    sample          10.443           ms/op
Client.existUser:existUser·p1.00      sample          10.486           ms/op
Client.getUser                        sample   9502    3.365 ± 0.224   ms/op
Client.getUser:getUser·p0.00          sample           0.626           ms/op
...
Client.getUser:getUser·p0.99          sample           8.568           ms/op
Client.getUser:getUser·p0.999         sample         106.955           ms/op
Client.getUser:getUser·p0.9999        sample         111.411           ms/op
Client.getUser:getUser·p1.00          sample         111.411           ms/op
Client.listUser                       sample   4355    7.327 ± 0.092   ms/op
Client.listUser:listUser·p0.00        sample           2.744           ms/op
Client.listUser:listUser·p0.50        sample           7.086           ms/op
Client.listUser:listUser·p0.90        sample           9.362           ms/op
Client.listUser:listUser·p0.95        sample          10.306           ms/op
Client.listUser:listUser·p0.99        sample          12.970           ms/op
Client.listUser:listUser·p0.999       sample          18.893           ms/op
