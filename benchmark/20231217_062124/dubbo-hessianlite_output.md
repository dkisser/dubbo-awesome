...
[INFO] Finished at: 2023-12-17T06:08:13Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.977 ±(99.9%) 0.052 ms/op
Iteration   1: 2.773 ±(99.9%) 0.018 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.251 ±(99.9%) 0.032 ms/op
Iteration   1: 1.904 ±(99.9%) 0.008 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.408 ±(99.9%) 0.055 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.064 ±(99.9%) 0.239 ms/op
Iteration   1: 8.501 ±(99.9%) 0.078 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.392 ±(99.9%) 0.121 ms/op
Iteration   1: 3.086 ±(99.9%) 0.031 ms/op
                 createUser·p0.00:   1.180 ms/op
                 createUser·p0.50:   2.998 ms/op
                 createUser·p0.90:   3.867 ms/op
                 createUser·p0.95:   4.153 ms/op
                 createUser·p0.99:   5.267 ms/op
                 createUser·p0.999:  15.641 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 2.998 ±(99.9%) 0.068 ms/op
...
Result "org.apache.dubbo.benchmark.Client.existUser":
  ...
  Percentiles, ms/op:
     ...
     p(99.9000) =      5.932 ms/op
     p(99.9900) =      6.495 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.545 ±(99.9%) 0.100 ms/op
Iteration   1: 2.669 ±(99.9%) 0.026 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.303 ±(99.9%) 0.354 ms/op
Iteration   1: 8.021 ±(99.9%) 0.116 ms/op
                 listUser·p0.00:   1.579 ms/op
                 listUser·p0.50:   7.537 ms/op
                 listUser·p0.90:   11.043 ms/op
                 listUser·p0.95:   11.656 ms/op
                 listUser·p0.99:   16.529 ms/op
...
Result "org.apache.dubbo.benchmark.Client.listUser":
  ...
  Percentiles, ms/op:
     ...
     p(95.0000) =     11.656 ms/op
     p(99.0000) =     16.529 ms/op
...
Client.createUser                      thrpt          7.258          ops/ms
Client.existUser                       thrpt         12.155          ops/ms
Client.getUser                         thrpt          9.379          ops/ms
Client.listUser                        thrpt          3.885          ops/ms
Client.createUser                       avgt          2.773           ms/op
Client.existUser                        avgt          1.904           ms/op
Client.getUser                          avgt          3.059           ms/op
Client.listUser                         avgt          8.501           ms/op
Client.createUser                     sample  10366   3.086 ± 0.031   ms/op
...
Client.createUser:createUser·p0.95    sample          4.153           ms/op
Client.createUser:createUser·p0.99    sample          5.267           ms/op
Client.createUser:createUser·p0.999   sample         15.641           ms/op
Client.createUser:createUser·p0.9999  sample         18.783           ms/op
Client.createUser:createUser·p1.00    sample         18.842           ms/op
Client.existUser                      sample  17143   1.869 ± 0.012   ms/op
...
Client.existUser:existUser·p0.99      sample          3.192           ms/op
Client.existUser:existUser·p0.999     sample          5.932           ms/op
Client.existUser:existUser·p0.9999    sample          6.495           ms/op
Client.existUser:existUser·p1.00      sample          6.513           ms/op
Client.getUser                        sample  11999   2.669 ± 0.026   ms/op
Client.getUser:getUser·p0.00          sample          0.947           ms/op
Client.getUser:getUser·p0.50          sample          2.494           ms/op
Client.getUser:getUser·p0.90          sample          3.322           ms/op
Client.getUser:getUser·p0.95          sample          3.666           ms/op
Client.getUser:getUser·p0.99          sample          5.816           ms/op
Client.getUser:getUser·p0.999         sample         13.795           ms/op
Client.getUser:getUser·p0.9999        sample         13.992           ms/op
Client.getUser:getUser·p1.00          sample         14.008           ms/op
Client.listUser                       sample   4015   8.021 ± 0.116   ms/op
Client.listUser:listUser·p0.00        sample          1.579           ms/op
Client.listUser:listUser·p0.50        sample          7.537           ms/op
Client.listUser:listUser·p0.90        sample         11.043           ms/op
Client.listUser:listUser·p0.95        sample         11.656           ms/op
Client.listUser:listUser·p0.99        sample         16.529           ms/op
Client.listUser:listUser·p0.999       sample         18.677           ms/op
