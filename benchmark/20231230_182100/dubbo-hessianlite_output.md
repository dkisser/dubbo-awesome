...
[INFO] Finished at: 2023-12-30T18:07:27Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.139 ±(99.9%) 0.067 ms/op
Iteration   1: 3.213 ±(99.9%) 0.031 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 2.973 ±(99.9%) 0.030 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.584 ±(99.9%) 0.063 ms/op
Iteration   1: 3.098 ±(99.9%) 0.019 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.556 ±(99.9%) 0.175 ms/op
Iteration   1: 8.592 ±(99.9%) 0.098 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.353 ±(99.9%) 0.096 ms/op
Iteration   1: 2.675 ±(99.9%) 0.035 ms/op
                 createUser·p0.00:   0.834 ms/op
                 createUser·p0.50:   2.527 ms/op
                 createUser·p0.90:   3.092 ms/op
                 createUser·p0.95:   3.604 ms/op
                 createUser·p0.99:   8.052 ms/op
                 createUser·p0.999:  17.943 ms/op
                 createUser·p0.9999: 20.354 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.337 ±(99.9%) 0.076 ms/op
Iteration   1: 1.973 ±(99.9%) 0.013 ms/op
                 ...
                 existUser·p0.9999: 9.951 ms/op
                 existUser·p1.00:   9.961 ms/op



Result "org.apache.dubbo.benchmark.Client.existUser":
  N = 16563
  mean =      1.973 ±(99.9%) 0.013 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.243 ±(99.9%) 0.098 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.339 ±(99.9%) 0.401 ms/op
Iteration   1: 8.243 ±(99.9%) 0.136 ms/op
                 listUser·p0.00:   2.716 ms/op
                 listUser·p0.50:   7.864 ms/op
                 listUser·p0.90:   11.164 ms/op
                 listUser·p0.95:   12.943 ms/op
                 listUser·p0.99:   16.958 ms/op
                 listUser·p0.999:  26.561 ms/op
...
Result "org.apache.dubbo.benchmark.Client.listUser":
  ...
  Percentiles, ms/op:
     ...
     p(90.0000) =     11.164 ms/op
     p(95.0000) =     12.943 ms/op
     p(99.0000) =     16.958 ms/op
     p(99.9000) =     26.561 ms/op
...
Client.existUser                       thrpt         14.123          ops/ms
Client.getUser                         thrpt          8.853          ops/ms
...
Client.listUser                         avgt          8.592           ms/op
Client.createUser                     sample  12135   2.675 ± 0.035   ms/op
Client.createUser:createUser·p0.00    sample          0.834           ms/op
Client.createUser:createUser·p0.50    sample          2.527           ms/op
Client.createUser:createUser·p0.90    sample          3.092           ms/op
Client.createUser:createUser·p0.95    sample          3.604           ms/op
Client.createUser:createUser·p0.99    sample          8.052           ms/op
Client.createUser:createUser·p0.999   sample         17.943           ms/op
Client.createUser:createUser·p0.9999  sample         20.354           ms/op
Client.createUser:createUser·p1.00    sample         20.382           ms/op
Client.existUser                      sample  16563   1.973 ± 0.013   ms/op
...
Client.existUser:existUser·p0.99      sample          3.155           ms/op
Client.existUser:existUser·p0.999     sample          7.127           ms/op
Client.existUser:existUser·p0.9999    sample          9.951           ms/op
Client.existUser:existUser·p1.00      sample          9.961           ms/op
Client.getUser                        sample  10427   3.074 ± 0.030   ms/op
Client.getUser:getUser·p0.00          sample          1.178           ms/op
Client.getUser:getUser·p0.50          sample          2.851           ms/op
Client.getUser:getUser·p0.90          sample          3.892           ms/op
Client.getUser:getUser·p0.95          sample          4.252           ms/op
Client.getUser:getUser·p0.99          sample          6.822           ms/op
Client.getUser:getUser·p0.999         sample         12.927           ms/op
Client.getUser:getUser·p0.9999        sample         13.921           ms/op
Client.getUser:getUser·p1.00          sample         13.959           ms/op
Client.listUser                       sample   3955   8.243 ± 0.136   ms/op
Client.listUser:listUser·p0.00        sample          2.716           ms/op
Client.listUser:listUser·p0.50        sample          7.864           ms/op
Client.listUser:listUser·p0.90        sample         11.164           ms/op
Client.listUser:listUser·p0.95        sample         12.943           ms/op
Client.listUser:listUser·p0.99        sample         16.958           ms/op
Client.listUser:listUser·p0.999       sample         26.561           ms/op
