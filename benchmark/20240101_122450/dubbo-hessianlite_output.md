...
[INFO] 
[INFO] benchmark-base ..................................... SUCCESS [  2.742 s]
...
[INFO] Finished at: 2024-01-01T12:11:19Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.278 ±(99.9%) 0.055 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.232 ±(99.9%) 0.030 ms/op
Iteration   1: 1.813 ±(99.9%) 0.014 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.874 ±(99.9%) 0.078 ms/op
Iteration   1: 3.183 ±(99.9%) 0.011 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.231 ±(99.9%) 0.211 ms/op
Iteration   1: 9.075 ±(99.9%) 0.078 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.892 ±(99.9%) 0.105 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 2.957 ±(99.9%) 0.064 ms/op
Iteration   1: 1.595 ±(99.9%) 0.013 ms/op
                 ...
                 existUser·p0.9999: 11.910 ms/op
...
Result "org.apache.dubbo.benchmark.Client.existUser":
  ...
  Percentiles, ms/op:
     ...
     p(99.9000) =     11.697 ms/op
     p(99.9900) =     11.910 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.602 ±(99.9%) 0.094 ms/op
Iteration   1: 3.411 ±(99.9%) 0.034 ms/op
...
Client.getUser                         thrpt          8.047          ops/ms
Client.listUser                        thrpt          3.371          ops/ms
Client.createUser                       avgt          2.914           ms/op
Client.existUser                        avgt          1.813           ms/op
Client.getUser                          avgt          3.183           ms/op
Client.listUser                         avgt          9.075           ms/op
Client.createUser                     sample  10945   2.956 ± 0.027   ms/op
Client.createUser:createUser·p0.00    sample          0.676           ms/op
Client.createUser:createUser·p0.50    sample          2.826           ms/op
Client.createUser:createUser·p0.90    sample          3.424           ms/op
Client.createUser:createUser·p0.95    sample          3.883           ms/op
Client.createUser:createUser·p0.99    sample          6.890           ms/op
Client.createUser:createUser·p0.999   sample         10.843           ms/op
Client.createUser:createUser·p0.9999  sample         14.713           ms/op
Client.createUser:createUser·p1.00    sample         14.713           ms/op
Client.existUser                      sample  20097   1.595 ± 0.013   ms/op
Client.existUser:existUser·p0.00      sample          0.569           ms/op
Client.existUser:existUser·p0.50      sample          1.509           ms/op
...
Client.existUser:existUser·p0.999     sample         11.697           ms/op
Client.existUser:existUser·p0.9999    sample         11.910           ms/op
Client.existUser:existUser·p1.00      sample         11.993           ms/op
Client.getUser                        sample   9380   3.411 ± 0.034   ms/op
Client.getUser:getUser·p0.00          sample          0.738           ms/op
Client.getUser:getUser·p0.50          sample          3.305           ms/op
Client.getUser:getUser·p0.90          sample          4.473           ms/op
Client.getUser:getUser·p0.95          sample          4.833           ms/op
Client.getUser:getUser·p0.99          sample          6.332           ms/op
Client.getUser:getUser·p0.999         sample         11.037           ms/op
Client.getUser:getUser·p0.9999        sample         11.174           ms/op
Client.getUser:getUser·p1.00          sample         11.174           ms/op
Client.listUser                       sample   3857   8.294 ± 0.123   ms/op
Client.listUser:listUser·p0.00        sample          1.184           ms/op
Client.listUser:listUser·p0.50        sample          8.036           ms/op
Client.listUser:listUser·p0.90        sample         11.308           ms/op
Client.listUser:listUser·p0.95        sample         12.485           ms/op
Client.listUser:listUser·p0.99        sample         15.412           ms/op
Client.listUser:listUser·p0.999       sample         19.608           ms/op
