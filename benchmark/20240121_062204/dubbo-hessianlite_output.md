...
[INFO] server-base ........................................ SUCCESS [  0.305 s]
[INFO] client-base ........................................ SUCCESS [  0.587 s]
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.377 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  4.440 s
[INFO] Finished at: 2024-01-21T06:08:32Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.400 ±(99.9%) 0.081 ms/op
Iteration   1: 2.813 ±(99.9%) 0.014 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.807 ±(99.9%) 0.036 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.437 ±(99.9%) 0.064 ms/op
Iteration   1: 3.437 ±(99.9%) 0.018 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.427 ±(99.9%) 0.261 ms/op
Iteration   1: 7.885 ±(99.9%) 0.078 ms/op
...
Iteration   1: 3.109 ±(99.9%) 0.026 ms/op
                 ...
                 createUser·p0.9999: 9.486 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.203 ±(99.9%) 0.099 ms/op
Iteration   1: 1.779 ±(99.9%) 0.043 ms/op
                 ...
                 existUser·p0.999:  42.601 ms/op
                 existUser·p0.9999: 44.043 ms/op
...
Result "org.apache.dubbo.benchmark.Client.existUser":
  ...
  Percentiles, ms/op:
     ...
     p(99.9000) =     42.601 ms/op
     p(99.9900) =     44.043 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.207 ±(99.9%) 0.102 ms/op
Iteration   1: 3.202 ±(99.9%) 0.046 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.636 ±(99.9%) 0.403 ms/op
Iteration   1: 7.645 ±(99.9%) 0.125 ms/op
                 listUser·p0.00:   2.470 ms/op
                 listUser·p0.50:   7.209 ms/op
                 listUser·p0.90:   9.983 ms/op
                 listUser·p0.95:   11.338 ms/op
                 listUser·p0.99:   20.451 ms/op
                 listUser·p0.999:  24.923 ms/op
...
Client.existUser                       thrpt         12.614          ops/ms
Client.getUser                         thrpt          8.191          ops/ms
Client.listUser                        thrpt          3.996          ops/ms
...
Client.createUser                     sample  10274   3.109 ± 0.026   ms/op
Client.createUser:createUser·p0.00    sample          1.305           ms/op
Client.createUser:createUser·p0.50    sample          3.088           ms/op
Client.createUser:createUser·p0.90    sample          3.992           ms/op
Client.createUser:createUser·p0.95    sample          4.284           ms/op
Client.createUser:createUser·p0.99    sample          5.325           ms/op
Client.createUser:createUser·p0.999   sample          7.709           ms/op
Client.createUser:createUser·p0.9999  sample          9.486           ms/op
Client.createUser:createUser·p1.00    sample          9.486           ms/op
Client.existUser                      sample  17957   1.779 ± 0.043   ms/op
Client.existUser:existUser·p0.00      sample          0.470           ms/op
...
Client.existUser:existUser·p0.999     sample         42.601           ms/op
Client.existUser:existUser·p0.9999    sample         44.043           ms/op
Client.existUser:existUser·p1.00      sample         44.564           ms/op
Client.getUser                        sample  10167   3.202 ± 0.046   ms/op
Client.getUser:getUser·p0.00          sample          0.918           ms/op
Client.getUser:getUser·p0.50          sample          3.052           ms/op
Client.getUser:getUser·p0.90          sample          3.985           ms/op
Client.getUser:getUser·p0.95          sample          4.437           ms/op
Client.getUser:getUser·p0.99          sample          5.825           ms/op
Client.getUser:getUser·p0.999         sample         24.936           ms/op
Client.getUser:getUser·p0.9999        sample         25.457           ms/op
Client.getUser:getUser·p1.00          sample         25.461           ms/op
Client.listUser                       sample   4186   7.645 ± 0.125   ms/op
Client.listUser:listUser·p0.00        sample          2.470           ms/op
Client.listUser:listUser·p0.50        sample          7.209           ms/op
Client.listUser:listUser·p0.90        sample          9.983           ms/op
Client.listUser:listUser·p0.95        sample         11.338           ms/op
Client.listUser:listUser·p0.99        sample         20.451           ms/op
Client.listUser:listUser·p0.999       sample         24.923           ms/op
