...
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.458 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  4.704 s
[INFO] Finished at: 2023-12-31T18:07:27Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.534 ±(99.9%) 0.078 ms/op
Iteration   1: 3.259 ±(99.9%) 0.012 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.207 ±(99.9%) 0.038 ms/op
Iteration   1: 2.089 ±(99.9%) 0.011 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.642 ±(99.9%) 0.089 ms/op
...
Iteration   1: 10.013 ±(99.9%) 0.084 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.450 ±(99.9%) 0.140 ms/op
Iteration   1: 3.085 ±(99.9%) 0.033 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.165 ±(99.9%) 0.068 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.558 ±(99.9%) 0.120 ms/op
Iteration   1: 2.843 ±(99.9%) 0.025 ms/op
...
Result "org.apache.dubbo.benchmark.Client.getUser":
  ...
  Percentiles, ms/op:
     ...
     p(99.9000) =      7.510 ms/op
     p(99.9900) =      8.143 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.348 ±(99.9%) 0.438 ms/op
Iteration   1: 9.256 ±(99.9%) 0.161 ms/op
                 listUser·p0.00:   3.056 ms/op
                 listUser·p0.50:   8.831 ms/op
                 listUser·p0.90:   12.324 ms/op
                 listUser·p0.95:   14.634 ms/op
                 listUser·p0.99:   18.350 ms/op
                 listUser·p0.999:  30.729 ms/op
...
Result "org.apache.dubbo.benchmark.Client.listUser":
  ...
  Percentiles, ms/op:
     ...
     p(90.0000) =     12.324 ms/op
     p(95.0000) =     14.634 ms/op
     p(99.0000) =     18.350 ms/op
     p(99.9000) =     30.729 ms/op
...
Client.existUser                       thrpt         12.788          ops/ms
Client.getUser                         thrpt          8.023          ops/ms
Client.listUser                        thrpt          3.411          ops/ms
Client.createUser                       avgt          3.259           ms/op
Client.existUser                        avgt          2.089           ms/op
Client.getUser                          avgt          3.403           ms/op
Client.listUser                         avgt         10.013           ms/op
Client.createUser                     sample  10354   3.085 ± 0.033   ms/op
...
Client.createUser:createUser·p0.999   sample         15.843           ms/op
Client.createUser:createUser·p0.9999  sample         15.940           ms/op
Client.createUser:createUser·p1.00    sample         15.942           ms/op
Client.existUser                      sample  16450   1.946 ± 0.012   ms/op
...
Client.existUser:existUser·p0.95      sample          2.717           ms/op
Client.existUser:existUser·p0.99      sample          3.154           ms/op
Client.existUser:existUser·p0.999     sample          4.503           ms/op
Client.existUser:existUser·p0.9999    sample          6.736           ms/op
Client.existUser:existUser·p1.00      sample          7.127           ms/op
Client.getUser                        sample  11251   2.843 ± 0.025   ms/op
Client.getUser:getUser·p0.00          sample          0.577           ms/op
Client.getUser:getUser·p0.50          sample          2.556           ms/op
Client.getUser:getUser·p0.90          sample          3.895           ms/op
Client.getUser:getUser·p0.95          sample          4.353           ms/op
Client.getUser:getUser·p0.99          sample          5.489           ms/op
Client.getUser:getUser·p0.999         sample          7.510           ms/op
Client.getUser:getUser·p0.9999        sample          8.143           ms/op
Client.getUser:getUser·p1.00          sample          8.167           ms/op
Client.listUser                       sample   3447   9.256 ± 0.161   ms/op
Client.listUser:listUser·p0.00        sample          3.056           ms/op
Client.listUser:listUser·p0.50        sample          8.831           ms/op
Client.listUser:listUser·p0.90        sample         12.324           ms/op
Client.listUser:listUser·p0.95        sample         14.634           ms/op
Client.listUser:listUser·p0.99        sample         18.350           ms/op
Client.listUser:listUser·p0.999       sample         30.729           ms/op
