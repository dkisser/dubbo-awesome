...
[INFO] dubbo-hessianlite-client ........................... SUCCESS [  0.376 s]
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  4.473 s
[INFO] Finished at: 2024-01-18T00:30:45Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.357 ±(99.9%) 0.056 ms/op
Iteration   1: 3.195 ±(99.9%) 0.024 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.871 ±(99.9%) 0.044 ms/op
Iteration   1: 1.862 ±(99.9%) 0.008 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.089 ±(99.9%) 0.062 ms/op
Iteration   1: 3.414 ±(99.9%) 0.015 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.465 ±(99.9%) 0.266 ms/op
Iteration   1: 7.104 ±(99.9%) 0.074 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.041 ±(99.9%) 0.121 ms/op
Iteration   1: 2.891 ±(99.9%) 0.031 ms/op
                 createUser·p0.00:   1.083 ms/op
                 createUser·p0.50:   2.675 ms/op
                 createUser·p0.90:   3.527 ms/op
                 createUser·p0.95:   3.937 ms/op
                 createUser·p0.99:   6.283 ms/op
                 createUser·p0.999:  15.154 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 2.825 ±(99.9%) 0.064 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 11.852 ±(99.9%) 0.451 ms/op
Iteration   1: 8.084 ±(99.9%) 0.100 ms/op
                 listUser·p0.00:   3.203 ms/op
                 listUser·p0.50:   7.799 ms/op
                 listUser·p0.90:   10.622 ms/op
                 listUser·p0.95:   11.665 ms/op
                 listUser·p0.99:   13.554 ms/op
                 listUser·p0.999:  19.772 ms/op
...
Result "org.apache.dubbo.benchmark.Client.listUser":
  ...
  Percentiles, ms/op:
     ...
     p(90.0000) =     10.622 ms/op
     p(95.0000) =     11.665 ms/op
     p(99.0000) =     13.554 ms/op
...
Client.existUser                       thrpt         12.609          ops/ms
Client.getUser                         thrpt          9.175          ops/ms
Client.listUser                        thrpt          3.823          ops/ms
Client.createUser                       avgt          3.195           ms/op
Client.existUser                        avgt          1.862           ms/op
Client.getUser                          avgt          3.414           ms/op
Client.listUser                         avgt          7.104           ms/op
Client.createUser                     sample  11073   2.891 ± 0.031   ms/op
...
Client.createUser:createUser·p0.95    sample          3.937           ms/op
Client.createUser:createUser·p0.99    sample          6.283           ms/op
Client.createUser:createUser·p0.999   sample         15.154           ms/op
Client.createUser:createUser·p0.9999  sample         15.235           ms/op
Client.createUser:createUser·p1.00    sample         15.237           ms/op
Client.existUser                      sample  17268   1.852 ± 0.014   ms/op
...
Client.existUser:existUser·p0.99      sample          4.033           ms/op
Client.existUser:existUser·p0.999     sample          7.827           ms/op
Client.existUser:existUser·p0.9999    sample          8.681           ms/op
Client.existUser:existUser·p1.00      sample          8.716           ms/op
Client.getUser                        sample  10466   3.080 ± 0.041   ms/op
Client.getUser:getUser·p0.00          sample          0.755           ms/op
Client.getUser:getUser·p0.50          sample          2.937           ms/op
Client.getUser:getUser·p0.90          sample          3.806           ms/op
Client.getUser:getUser·p0.95          sample          4.148           ms/op
Client.getUser:getUser·p0.99          sample          5.423           ms/op
Client.getUser:getUser·p0.999         sample         23.169           ms/op
Client.getUser:getUser·p0.9999        sample         25.764           ms/op
Client.getUser:getUser·p1.00          sample         25.788           ms/op
Client.listUser                       sample   3956   8.084 ± 0.100   ms/op
Client.listUser:listUser·p0.00        sample          3.203           ms/op
Client.listUser:listUser·p0.50        sample          7.799           ms/op
Client.listUser:listUser·p0.90        sample         10.622           ms/op
Client.listUser:listUser·p0.95        sample         11.665           ms/op
Client.listUser:listUser·p0.99        sample         13.554           ms/op
Client.listUser:listUser·p0.999       sample         19.772           ms/op
