...
[INFO] Finished at: 2023-12-21T06:09:03Z
[INFO] ------------------------------------------------------------------------
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.177 ±(99.9%) 0.068 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 3.176 ±(99.9%) 0.053 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.836 ±(99.9%) 0.079 ms/op
Iteration   1: 3.327 ±(99.9%) 0.020 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.578 ±(99.9%) 0.232 ms/op
Iteration   1: 8.468 ±(99.9%) 0.094 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 5.821 ±(99.9%) 0.199 ms/op
Iteration   1: 2.969 ±(99.9%) 0.021 ms/op
                 ...
                 createUser·p0.9999: 8.301 ms/op
                 createUser·p1.00:   8.339 ms/op



Result "org.apache.dubbo.benchmark.Client.createUser":
  N = 10797
  mean =      2.969 ±(99.9%) 0.021 ms/op
...
Iteration   1: 2.103 ±(99.9%) 0.147 ms/op
                 existUser·p0.00:   0.286 ms/op
                 existUser·p0.50:   1.714 ms/op
                 existUser·p0.90:   2.261 ms/op
                 existUser·p0.95:   2.522 ms/op
                 existUser·p0.99:   4.375 ms/op
                 existUser·p0.999:  118.852 ms/op
                 existUser·p0.9999: 135.758 ms/op
                 existUser·p1.00:   136.577 ms/op



Result "org.apache.dubbo.benchmark.Client.existUser":
  N = 15204
  mean =      2.103 ±(99.9%) 0.147 ms/op
  ...
  Percentiles, ms/op:
     ...
     p(95.0000) =      2.522 ms/op
     p(99.0000) =      4.375 ms/op
     p(99.9000) =    118.852 ms/op
     p(99.9900) =    135.758 ms/op
     p(99.9990) =    136.577 ms/op
     p(99.9999) =    136.577 ms/op
    p(100.0000) =    136.577 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 4.309 ±(99.9%) 0.105 ms/op
Iteration   1: 3.641 ±(99.9%) 0.028 ms/op
...
# Fork: 1 of 1
# Warmup Iteration   1: 12.499 ±(99.9%) 0.480 ms/op
Iteration   1: 9.631 ±(99.9%) 0.175 ms/op
                 listUser·p0.00:   3.183 ms/op
                 listUser·p0.50:   9.142 ms/op
                 listUser·p0.90:   12.599 ms/op
                 listUser·p0.95:   13.838 ms/op
                 listUser·p0.99:   24.237 ms/op
                 listUser·p0.999:  33.771 ms/op
...
Result "org.apache.dubbo.benchmark.Client.listUser":
  ...
  Percentiles, ms/op:
     ...
     p(95.0000) =     13.838 ms/op
     p(99.0000) =     24.237 ms/op
     p(99.9000) =     33.771 ms/op
...
Client.createUser                      thrpt           6.576          ops/ms
Client.existUser                       thrpt          12.885          ops/ms
Client.getUser                         thrpt           8.610          ops/ms
Client.listUser                        thrpt           3.429          ops/ms
Client.createUser                       avgt           3.342           ms/op
Client.existUser                        avgt           1.855           ms/op
Client.getUser                          avgt           3.327           ms/op
Client.listUser                         avgt           8.468           ms/op
Client.createUser                     sample  10797    2.969 ± 0.021   ms/op
...
Client.createUser:createUser·p0.99    sample           5.440           ms/op
Client.createUser:createUser·p0.999   sample           7.176           ms/op
Client.createUser:createUser·p0.9999  sample           8.301           ms/op
Client.createUser:createUser·p1.00    sample           8.339           ms/op
Client.existUser                      sample  15204    2.103 ± 0.147   ms/op
Client.existUser:existUser·p0.00      sample           0.286           ms/op
Client.existUser:existUser·p0.50      sample           1.714           ms/op
Client.existUser:existUser·p0.90      sample           2.261           ms/op
Client.existUser:existUser·p0.95      sample           2.522           ms/op
Client.existUser:existUser·p0.99      sample           4.375           ms/op
Client.existUser:existUser·p0.999     sample         118.852           ms/op
Client.existUser:existUser·p0.9999    sample         135.758           ms/op
Client.existUser:existUser·p1.00      sample         136.577           ms/op
Client.getUser                        sample   8787    3.641 ± 0.028   ms/op
Client.getUser:getUser·p0.00          sample           0.862           ms/op
Client.getUser:getUser·p0.50          sample           3.588           ms/op
Client.getUser:getUser·p0.90          sample           4.547           ms/op
Client.getUser:getUser·p0.95          sample           4.948           ms/op
Client.getUser:getUser·p0.99          sample           6.513           ms/op
Client.getUser:getUser·p0.999         sample           8.132           ms/op
Client.getUser:getUser·p0.9999        sample          10.387           ms/op
Client.getUser:getUser·p1.00          sample          10.387           ms/op
Client.listUser                       sample   3347    9.631 ± 0.175   ms/op
Client.listUser:listUser·p0.00        sample           3.183           ms/op
Client.listUser:listUser·p0.50        sample           9.142           ms/op
Client.listUser:listUser·p0.90        sample          12.599           ms/op
Client.listUser:listUser·p0.95        sample          13.838           ms/op
Client.listUser:listUser·p0.99        sample          24.237           ms/op
Client.listUser:listUser·p0.999       sample          33.771           ms/op
